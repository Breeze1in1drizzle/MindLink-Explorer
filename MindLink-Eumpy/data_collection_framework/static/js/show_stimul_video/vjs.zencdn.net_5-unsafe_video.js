	...
	return (function e(t, n, r) {
		...
		2: [function(_dereq_, module, exports) {
			...
			var Button = function(_ClickableComponent) {
				...
				Button.prototype.createEl = function createEl() {
					...
					if (tag !== 'button') {
						_log2['default'].warn('Creating a Button with an HTML element of ' + tag +
				...
				Button.prototype.addChild = function addChild(child) {
					...
					_log2['default'].warn('Adding an actionable (user controllable) child to a Button (' + className +
		...
		3: [function(_dereq_, module, exports) {
			...
			var ClickableComponent = function(_Component) {
				...
				ClickableComponent.prototype.createEl = function createEl() {
					...
					if (tag === 'button') {
						_log2['default'].error('Creating a ClickableComponent with an HTML element of ' + tag +
			...
			var Component = function() {
				...
				Component.prototype.addChild = function addChild(child) {
					...
					if (typeof child === 'string') {
						...
						if (options === true) {
							_log2['default'].warn('Initializing a child component with `true` is deprecated.' +
				...
				Component.registerComponent = function registerComponent(name, comp) {
					...
					if (name === 'Player' && Component.components_[name]) {
						...
						if (Player.players && Object.keys(Player.players).length > 0 && Object.keys(Player.players).map(function(
								playerName) {
				...
				Component.extend = function extend(props) {
					...
					_log2['default'].warn('Component.extend({}) has been deprecated, ' +
		...
		16: [function(_dereq_, module, exports) {
			...
			var MouseTimeDisplay = function(_Component) {
				...
				function MouseTimeDisplay(player, options) {
					...
					if (options.playerOptions && options.playerOptions.controlBar && options.playerOptions.controlBar.progressControl &&
					...
					player.on('ready', function() {
						_this.on(player.controlBar.progressControl.el(), 'mousemove', Fn.throttle(Fn.bind(_this, _this.handleMouseMove),
							25));
					});
					return _this;
				}
		...
		43: [function(_dereq_, module, exports) {
			...
			var _inherits = function _inherits(subClass, superClass) {
				if (typeof superClass !== 'function' && superClass !== null) {
					throw new TypeError('Super expression must either be null or a function, not ' + (typeof superClass ===
						'undefined' ? 'undefined' : _typeof(superClass)));
				}
		...
		46: [function(_dereq_, module, exports) {
			 ...
			 */
			MediaError.errorTypes = ['MEDIA_ERR_CUSTOM', 'MEDIA_ERR_ABORTED', 'MEDIA_ERR_NETWORK', 'MEDIA_ERR_DECODE',
		...
		51: [function(_dereq_, module, exports) {
			...
			var Player = function(_Component) {
				...
				function Player(tag, options, ready) {
					...
					if (!_this.options_ || !_this.options_.techOrder || !_this.options_.techOrder.length) {
						throw new Error('No techOrder specified. Did you overwrite ' +
							'videojs.options instead of just changing the ' + 'properties you want to override?');
					}
				...
				Player.prototype.createEl = function createEl() {
					var tag = this.tag;
					var el = void 0;
					var playerElIngest = this.playerElIngest_ = tag.parentNode && tag.parentNode.hasAttribute && tag.parentNode
					...
					if (this.tech_ && this.tech_.isReady_) {
						...
						try {
							...
							if (this.tech_[method] === undefined) {
								(0, _log2['default'])('Video.js: ' + method + ' method not defined for ' + this.techName_ +
									' playback technology.', e);

								// When a method isn't available on the object it throws a TypeError
							} else if (e.name === 'TypeError') {
								(0, _log2['default'])('Video.js: ' + method + ' unavailable on ' + this.techName_ +
				...
				Player.prototype.canPlayType = function canPlayType(type) {
					...
					for (var i = 0, j = this.options_.techOrder; i < j.length; i++) {
						...
						if (!tech) {
							_log2['default'].error('The "' + techName +
				...
				Player.prototype.error = function error(err) {
					...
					_log2['default'].error('(CODE:' + this.error_.code + ' ' + _mediaError2['default'].errorTypes[this.error_.code] +
				...
				Player.prototype.flexNotSupported_ = function flexNotSupported_() {
					...
					return !('flexBasis' in elem.style || 'webkitFlexBasis' in elem.style || 'mozFlexBasis' in elem.style ||
			...
			Player.prototype.options_ = {
				...
				language: navigator && (navigator.languages && navigator.languages[0] || navigator.userLanguage || navigator.language) ||
					'en',
		...
		59: [function(_dereq_, module, exports) {
			...
			var Flash = function(_Tech) {
				...
				Flash.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
					...
					} else if (_window2['default'].performance && _window2['default'].performance.timing && typeof _window2[
							'default'].performance.timing.navigationStart === 'number') {
						videoPlaybackQuality.creationTime = _window2['default'].Date.now() - _window2['default'].performance.timing
							.navigationStart;
					}
			...
			Flash.version = function() {
				...
				// IE
				try {
					version = new _window2['default'].ActiveXObject('ShockwaveFlash.ShockwaveFlash').GetVariable('$version').replace(
						/\D+/g, ',').match(/^,?(.+),?$/)[1];
					...
					try {
						if (navigator.mimeTypes['application/x-shockwave-flash'].enabledPlugin) {
							version = (navigator.plugins['Shockwave Flash 2.0'] || navigator.plugins['Shockwave Flash']).description.replace(
								/\D+/g, ',').match(/^,?(.+),?$/)[1];
						}
					} catch (err) {
						// satisfy linter
		...
		60: [function(_dereq_, module, exports) {
			...
			var Html5 = function(_Tech) {
				...
				function Html5(options, ready) {
					...
					if ((browser.TOUCH_ENABLED || browser.IS_IPHONE || browser.IS_NATIVE_ANDROID) && options.nativeControlsForTouch ===
						true) {
				...
				Html5.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
					...
					if (typeof this.el().webkitDroppedFrameCount !== 'undefined' && typeof this.el().webkitDecodedFrameCount !==
						'undefined') {
		...
		68: [function(_dereq_, module, exports) {
			...
			function constructColor(color, opacity) {
				return 'rgba(' +
					...
					parseInt(color[1] + color[1], 16) + ',' + parseInt(color[2] + color[2], 16) + ',' + parseInt(color[3] + color[
						3], 16) + ',' + opacity + ')';
			}
				...
				TextTrackDisplay.prototype.updateForTrack = function updateForTrack(track) {
					...
					while (i--) {
						...
						if (overrides.backgroundOpacity) {
							tryUpdateStyle(cueDiv.firstChild, 'backgroundColor', constructColor(overrides.backgroundColor || '#000',
						...
						if (overrides.edgeStyle) {
							if (overrides.edgeStyle === 'dropshadow') {
								cueDiv.firstChild.style.textShadow = '2px 2px 3px ' + darkGray + ', 2px 2px 4px ' + darkGray +
									', 2px 2px 5px ' + darkGray;
							} else if (overrides.edgeStyle === 'raised') {
								cueDiv.firstChild.style.textShadow = '1px 1px ' + darkGray + ', 2px 2px ' + darkGray + ', 3px 3px ' +
									darkGray;
							} else if (overrides.edgeStyle === 'depressed') {
								cueDiv.firstChild.style.textShadow = '1px 1px ' + lightGray + ', 0 1px ' + lightGray + ', -1px -1px ' +
									darkGray + ', 0 -1px ' + darkGray;
							} else if (overrides.edgeStyle === 'uniform') {
								cueDiv.firstChild.style.textShadow = '0 0 4px ' + darkGray + ', 0 0 4px ' + darkGray + ', 0 0 4px ' +
									darkGray + ', 0 0 4px ' + darkGray;
							}
						}
		...
		71: [function(_dereq_, module, exports) {
			...
			var selectConfigs = {
				backgroundColor: {
					...
					label: 'Color',
					options: [COLOR_BLACK, COLOR_WHITE, COLOR_RED, COLOR_GREEN, COLOR_BLUE, COLOR_YELLOW, COLOR_MAGENTA,
						COLOR_CYAN
					]
				},
				...
				color: {
					...
					label: 'Color',
					options: [COLOR_WHITE, COLOR_BLACK, COLOR_RED, COLOR_GREEN, COLOR_BLUE, COLOR_YELLOW, COLOR_MAGENTA,
						COLOR_CYAN
					]
				},
		...
		72: [function(_dereq_, module, exports) {
			...
			var parseCues = function parseCues(srcContent, track) {
				var parser = new _window2['default'].WebVTT.Parser(_window2['default'], _window2['default'].vttjs, _window2[
		...
		78: [function(_dereq_, module, exports) {
			...
			exports.__esModule = true;
			exports.BACKGROUND_SIZE_SUPPORTED = exports.TOUCH_ENABLED = exports.IS_ANY_SAFARI = exports.IS_SAFARI = exports
				.IE_VERSION = exports.IS_IE8 = exports.CHROME_VERSION = exports.IS_CHROME = exports.IS_EDGE = exports.IS_FIREFOX =
				exports.IS_NATIVE_ANDROID = exports.IS_OLD_ANDROID = exports.ANDROID_VERSION = exports.IS_ANDROID = exports.IOS_VERSION =
			...
			var IS_NATIVE_ANDROID = exports.IS_NATIVE_ANDROID = IS_ANDROID && ANDROID_VERSION < 5 && appleWebkitVersion <
				537;
			...
			var TOUCH_ENABLED = exports.TOUCH_ENABLED = Dom.isReal() && ('ontouchstart' in _window2['default'] || _window2[
				'default'].DocumentTouch && _window2['default'].document instanceof _window2['default'].DocumentTouch);

			var BACKGROUND_SIZE_SUPPORTED = exports.BACKGROUND_SIZE_SUPPORTED = Dom.isReal() && 'backgroundSize' in
			...
			function fixEvent(event) {
				...
				if (!event || !event.isPropagationStopped) {
					...
					for (var key in old) {
						...
						if (key !== 'layerX' && key !== 'layerY' && key !== 'keyLocation' && key !== 'webkitMovementX' && key !==
							'webkitMovementY') {
		...
		86: [function(_dereq_, module, exports) {
			...
			var logByType = exports.logByType = function logByType(type, args) {
				var stringify = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !!_browser.IE_VERSION &&
					_browser.IE_VERSION < 11;
		...
		90: [function(_dereq_, module, exports) {
			...
			function rangeCheck(fnName, index, maxIndex) {
				if (index < 0 || index > maxIndex) {
					throw new Error('Failed to execute \'' + fnName + '\' on \'TimeRanges\': The index provided (' + index +
			...
			function getRange(fnName, valueIndex, ranges, rangeIndex) {
				if (rangeIndex === undefined) {
					_log2['default'].warn('DEPRECATED: Function \'' + fnName +
		...
		93: [function(_dereq_, module, exports) {
			...
			videojs.addLanguage = function(code, data) {
				...
				videojs.options.languages = (0, _mergeOptions3['default'])(videojs.options.languages, (_mergeOptions = {},
					_mergeOptions[code] = data, _mergeOptions));
			...
			} else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module ===
					'undefined' ? 'undefined' : _typeof(module)) === 'object') {
		...
		104: [function(_dereq_, module, exports) {
			...
			createXHR.XDomainRequest = "withCredentials" in (new createXHR.XMLHttpRequest()) ? createXHR.XMLHttpRequest :
			...
			function getXml(xhr) {
				...
				var firefoxBugTakenEffect = xhr.status === 204 && xhr.responseXML && xhr.responseXML.documentElement.nodeName ===
					"parsererror"
