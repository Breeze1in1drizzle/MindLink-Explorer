...
! function(t, e) {
	...
	function i(t, e, r) {
		...
		for (var o in e)
			if (e.hasOwnProperty(o)) {
				var a = t[o],
					s = e[o];
				!w(s) || !w(a) || y(s) || y(a) || M(s) || M(a) || b(s) || b(a) || z(s) || z(a) ? !r && o in t || (t[o] = n(e[o], !
					0)) : i(a, s, r)
			} return t
	}
	...
	function d(t, e, n) {
		if (t && e)
			if (t.forEach && t.forEach === Kp) t.forEach(e, n);
	...
	function it(t, e, n, i) {
		return n = n || {}, i || !Xp.canvasSupported ? rt(t, e, n) : Xp.browser.firefox && null != e.layerX && e.layerX !==
			e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : rt(
				t, e, n), n
	}
	...
	function yt(t, e, n) {
		var i = e[0],
			...
			u = Math.sin(n),
			h = Math.cos(n);
		return t[0] = i * h + a * u, t[1] = -i * u + a * h, t[2] = r * h + s * u, t[3] = -r * u + h * s, t[4] = h * o + u *
			l, t[5] = h * l - u * o, t
	}
	...
	function _t(t, e) {
		var n = e[0],
			...
			s = e[5],
			l = n * a - o * i;
		return l ? (l = 1 / l, t[0] = a * l, t[1] = -o * l, t[2] = -i * l, t[3] = n * l, t[4] = (i * s - a * r) * l, t[5] =
			(o * r - n * s) * l, t) : null
	}
	...
	function Ot(t, e) {
		if (t) {
			...
			if ("#" !== i.charAt(0)) {
				...
				if (4 === i.length) return (u = parseInt(i.substr(1), 16)) >= 0 && u <= 4095 ? (kt(e, (3840 & u) >> 4 | (3840 & u) >>
					8, 240 & u | (240 & u) >> 4, 15 & u | (15 & u) << 4, 1), Lt(t, e), e) : void kt(e, 0, 0, 0, 1);
				if (7 === i.length) {
					var u = parseInt(i.substr(1), 16);
					return u >= 0 && u <= 16777215 ? (kt(e, (16711680 & u) >> 16, (65280 & u) >> 8, 255 & u, 1), Lt(t, e), e) : void kt(
						e, 0, 0, 0, 1)
				}
			}
		}
	...
	function zt(t, e) {
		var n = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
			...
			o = r <= .5 ? r * (i + 1) : r + i - r * i,
			a = 2 * r - o;
		return e = e || [], kt(e, St(255 * At(a, o, n + 1 / 3)), St(255 * At(a, o, n)), St(255 * At(a, o, n - 1 / 3)), 1), 4 ===
			t.length && (e[3] = t[3]), e
	}
		...
		if (t) {
			...
			if (0 === l) e = 0, n = 0;
				...
				var h = ((s - i) / 6 + l / 2) / l,
					c = ((s - r) / 6 + l / 2) / l,
					d = ((s - o) / 6 + l / 2) / l;
				i === s ? e = d - c : r === s ? e = 1 / 3 + h - d : o === s && (e = 2 / 3 + c - h), e < 0 && (e += 1), e > 1 && (e -=
					1)
			}
			var f = [360 * e, n, u];
	...
	function Bt(t, e, n) {
		if (e && e.length && t >= 0 && t <= 1) {
			...
			var i = t * (e.length - 1),
				...
				s = e[o],
				l = i - r;
			return n[0] = St(Dt(a[0], s[0], l)), n[1] = St(Dt(a[1], s[1], l)), n[2] = St(Dt(a[2], s[2], l)), n[3] = It(Dt(a[3],
				s[3], l)), n
		}
	}
	...
	function Xt(t, e, n, i, r) {
		var o = t.length;
		if (1 == r)
			for (s = 0; s < o; s++) i[s] = Zt(t[s], e[s], n);
		else
			for (var a = o && t[0].length, s = 0; s < o; s++)
				for (var l = 0; l < a; l++) i[s][l] = Zt(t[s][l], e[s][l], n)
	}
	...
	function Yt(t, e, n) {
		...
		if (i !== r)
			if (i > r) t.length = r;
				...
				for (a = i; a < r; a++) t.push(1 === n ? e[a] : Hg.call(e[a]));
	...
	function qt(t, e, n, i, r, o, a, s, l) {
		var u = t.length;
		if (1 == l)
			for (c = 0; c < u; c++) s[c] = $t(t[c], e[c], n[c], i[c], r, o, a);
		else
			for (var h = t[0].length, c = 0; c < u; c++)
				for (var d = 0; d < h; d++) s[c][d] = $t(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
	}
			...
			if (o || !x) {
				...
				var O = new bt({
					...
					onframe: function(t, e) {
						...
						if (0 !== i)
							if (I = (e - m[n]) / i, l)
								if (C = v[n], T = v[0 === n ? n : n - 1], A = v[n > u - 2 ? u - 1 : n + 1], D = v[n > u - 3 ? u - 1 : n + 2],
									d) qt(T, C, A, D, I, I * I, I * I * I, a(t, r), g);
								else {
									if (f) o = qt(T, C, A, D, I, I * I, I * I * I, L, 1), o = Qt(L);
									else {
						...
						else if (d) Xt(v[n], v[n + 1], I, a(t, r), g);
						else {
							var o;
							if (f) Xt(v[n], v[n + 1], I, L, 1), o = Qt(L);
							else {
	...
	function ee(t, e, n, i, r, o, a, s) {
		_(i) ? (o = r, r = i, i = 0) : x(r) ? (o = r, r = "linear", i = 0) : x(i) ? (o = i, i = 0) : x(n) ? (o = n, n = 500) :
			n || (n = 500), t.stopAnimation(), ne(t, "", t, e, n, i, s);
	...
	function ne(t, e, n, i, r, o, a) {
		var s = {},
			l = 0;
		for (var u in i) i.hasOwnProperty(u) && (null != n[u] ? w(i[u]) && !c(i[u]) ? ne(t, e ? e + "." + u : u, n[u], i[u],
			r, o, a) : (a ? (s[u] = n[u], ie(t, e, u, i[u])) : s[u] = i[u], l++) : null == i[u] || a || ie(t, e, u, i[u]));
	...
	function pe(t, e, n) {
		var i = null == e.x ? 0 : e.x,
			...
			o = null == e.y ? 0 : e.y,
			a = null == e.y2 ? 0 : e.y2;
		return e.global || (i = i * n.width + n.x, r = r * n.width + n.x, o = o * n.height + n.y, a = a * n.height + n.y), i =
			isNaN(i) ? 0 : i, r = isNaN(r) ? 1 : r, o = isNaN(o) ? 0 : o, a = isNaN(a) ? 0 : a, t.createLinearGradient(i, o, r,
				a)
	}
	...
	function ve(t, e, n) {
		var i = ig(),
			...
			o = e.getHeight(),
			a = i.style;
		return a && (a.position = "absolute", a.left = 0, a.top = 0, a.width = r + "px", a.height = o + "px", i.setAttribute(
			"data-zr-dom-id", t)), i.width = r * n, i.height = o * n, i
	}
	...
	function Me(t, e, n, i, r, o) {
		...
		r && (s += r[1] + r[3]);
		var l = a.outerHeight,
			u = new re(Te(0, s, n), Ce(0, l, i), s, l);
	...
	function Ee(t, e, n, i) {
		...
		if (n && (s += n[0] + n[2]), t && i) {
			...
			if (null != l && s > l) t = "", o = [];
				...
				for (var h = ke(u - (n ? n[1] + n[3] : 0), e, i.ellipsis, {
						minChar: i.minChar,
	...
	function Ne(t, e) {
		...
		for (k = 0; k < a.length; k++) {
			for (var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
				var y = (P = p.tokens[v]).styleName && e.rich[P.styleName] || {},
					...
					w = P.textHeight = C(y.textHeight, Oe(_));
				if (x && (w += x[0] + x[2]), P.height = w, P.lineHeight = A(y.textLineHeight, e.textLineHeight, w), P.textAlign =
					y && y.textAlign || e.textAlign, P.textVerticalAlign = y && y.textVerticalAlign || "middle", null != f && s + P.lineHeight >
					f) return {
					lines: [],
					width: 0,
					height: 0
				...
				if ("string" == typeof b && "%" === b.charAt(b.length - 1)) P.percentWidth = b, u.push(P), b = 0;
					...
					null != D && D < b && (!S || D < T ? (P.text = "", P.textWidth = b = 0) : (P.text = De(P.text, D - T, _, c.ellipsis, {
						minChar: c.minChar
		...
		n.outerWidth = n.width = C(e.textWidth, l), n.outerHeight = n.height = C(e.textHeight, s), h && (n.outerWidth += h[1] +
	...
	function Fe(t, e) {
		...
		l < 0 && (a += l, l = -l), u < 0 && (s += u, u = -u), "number" == typeof h ? n = i = r = o = h : h instanceof Array ?
			1 === h.length ? n = i = r = o = h[0] : 2 === h.length ? (n = r = h[0], i = o = h[1]) : 3 === h.length ? (n = h[0],
				i = o = h[1], r = h[2]) : (n = h[0], i = h[1], r = h[2], o = h[3]) : n = i = r = o = 0;
		var c;
		n + i > l && (n *= l / (c = n + i), i *= l / c), r + o > l && (r *= l / (c = r + o), o *= l / c), i + r > u && (i *=
				u / (c = i + r), r *= u / c), n + o > u && (n *= u / (c = n + o), o *= u / c), t.moveTo(a + n, s), t.lineTo(a + l -
				i, s), 0 !== i && t.arc(a + l - i, s + i, i, -Math.PI / 2, 0), t.lineTo(a + l, s + u - r), 0 !== r && t.arc(a + l -
				r, s + u - r, r, 0, Math.PI / 2), t.lineTo(a + o, s + u), 0 !== o && t.arc(a + o, s + u - o, o, Math.PI / 2, Math.PI),
	...
	function We(t) {
		if (t) {
			...
			"center" === n && (n = "middle"), t.textVerticalAlign = null == n || wm[n] ? n : "top", t.textPadding && (t.textPadding =
				k(t.textPadding))
		}
	}
	...
	function Ge(t, e, n, i, r, o) {
		...
		b += p / 2;
		var k = i.textStrokeWidth,
			P = s ? a.textStrokeWidth : null,
			L = !s || k !== P,
			O = !s || L || i.textStroke !== a.textStroke,
			z = Je(i.textStroke, k),
			E = tn(i.textFill);
		if (z && (L && (e.lineWidth = k), O && (e.strokeStyle = z)), E && (s && i.textFill === a.textFill && !a.textBackgroundColor ||
				(e.fillStyle = E)), 1 === f.length) z && e.strokeText(f[0], w, b), E && e.fillText(f[0], w, b);
		else
			for (var N = 0; N < f.length; N++) z && e.strokeText(f[N], w, b), E && e.fillText(f[N], w, b), b += p
	}
	...
	function Ue(t, e, n, i, r) {
		...
		for (var x = 0; x < n.lines.length; x++) {
			for (var _, w = n.lines[x], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, T = 0, C = m, A = y, D = S -
					1; T < S && (!(_ = b[T]).textAlign || "left" === _.textAlign);) Ye(t, e, _, i, M, v, C, "left"), I -= _.width, C +=
				_.width, T++;
			for (; D >= 0 && "right" === (_ = b[D]).textAlign;) Ye(t, e, _, i, M, v, A, "right"), I -= _.width, A -= _.width, D--;
			for (C += (o - (C - m) - (y - A) - I) / 2; T <= D;) Ye(t, e, _ = b[T], i, M, v, C + _.width / 2, "center"), C += _.width,
				T++;
			v += M
		}
	}
	...
	function Xe(t, e, n, i, r) {
		if (n && e.textRotation) {
			var o = e.textOrigin;
			"center" === o ? (i = n.width / 2 + n.x, r = n.height / 2 + n.y) : o && (i = o[0] + n.x, r = o[1] + n.y), t.translate(
	...
	function Ye(t, e, n, i, r, o, a, s) {
		...
		var u = n.textVerticalAlign,
			h = o + r / 2;
		"top" === u ? h = o + n.height / 2 : "bottom" === u && (h = o + r - n.height / 2), !n.isLineHolder && je(l) && qe(t,
			e, l, "right" === s ? a - n.width : "center" === s ? a - n.width / 2 : a, h - n.height / 2, n.width, n.height);
		var c = n.textPadding;
		c && (a = nn(a, s, c), h -= n.height / 2 - c[2] - n.textHeight / 2), Qe(e, "shadowBlur", A(l.textShadowBlur, i.textShadowBlur,
			0)), Qe(e, "shadowColor", l.textShadowColor || i.textShadowColor || "transparent"), Qe(e, "shadowOffsetX", A(l.textShadowOffsetX,
			i.textShadowOffsetX, 0)), Qe(e, "shadowOffsetY", A(l.textShadowOffsetY, i.textShadowOffsetY, 0)), Qe(e,
			"textAlign", s), Qe(e, "textBaseline", "middle"), Qe(e, "font", n.font || ym);
		var d = Je(l.textStroke || i.textStroke, p),
			f = tn(l.textFill || i.textFill),
			p = C(l.textStrokeWidth, i.textStrokeWidth);
		d && (Qe(e, "lineWidth", p), Qe(e, "strokeStyle", d), e.strokeText(n.text, a, h)), f && (Qe(e, "fillStyle", f), e.fillText(
			n.text, a, h))
	}
	...
	function qe(t, e, n, i, r, o, a) {
		var s = n.textBackgroundColor,
			...
			u = n.textBorderColor,
			h = _(s);
		if (Qe(e, "shadowBlur", n.textBoxShadowBlur || 0), Qe(e, "shadowColor", n.textBoxShadowColor || "transparent"), Qe(e,
				"shadowOffsetX", n.textBoxShadowOffsetX || 0), Qe(e, "shadowOffsetY", n.textBoxShadowOffsetY || 0), h || l && u) {
			e.beginPath();
		...
		if (h)
			if (Qe(e, "fillStyle", s), null != n.fillOpacity) {
				f = e.globalAlpha;
				e.globalAlpha = n.fillOpacity * n.opacity, e.fill(), e.globalAlpha = f
			} else e.fill();
		else if (x(s)) Qe(e, "fillStyle", s(n)), e.fill();
		else if (w(s)) {
			var d = s.image;
			(d = xe(d, null, t, $e, s)) && we(d) && e.drawImage(d, i, r, o, a)
		}
		if (l && u)
			if (Qe(e, "lineWidth", l), Qe(e, "strokeStyle", u), null != n.strokeOpacity) {
				var f = e.globalAlpha;
	...
	function Ke(t, e, n) {
		...
		if (n) {
			...
			if (s instanceof Array) i = n.x + en(s[0], n.width), r = n.y + en(s[1], n.height);
			else {
	...
	function un(t, e, n) {
		return Im.copy(t.getBoundingRect()), t.transform && Im.applyTransform(t.transform), Tm.width = e, Tm.height = n, !Im
			.intersect(Tm)
	}
	...
	function _n(t) {
		...
		pg.call(this), this.dom = t, this._touching = !1, this._touchTimer, this._gestureMgr = new Dm, this._handlers = {},
			xn(this), Xp.pointerEventsSupported ? e(zm, this) : (Xp.touchEventsSupported && e(Lm, this), e(Pm, this))
	}
	...
	function Dn(t) {
		...
		Hm(t, function(t, n) {
			...
			var i = t.option;
			P(!i || null == i.id || !e.get(i.id) || e.get(i.id) === t, "id duplicates: " + (i && i.id)), i && null != i.id &&
			...
			var i = t.exist,
				...
				o = t.keyInfo;
			if (Gm(r)) {
				if (o.name = null != r.name ? r.name + "" : i ? i.name : Um + n, i) o.id = i.id;
		...
		return Hm(e, function(i, r) {
			...
			if ("dataIndex" !== r && "dataIndexInside" !== r) {
				var a = r.match(/^(\w+)(Index|Id|Name)$/) || [],
					s = a[1],
					u = (a[2] || "").toLowerCase();
				if (!(!s || !u || null == i || "index" === u && "none" === i || n && n.includeMainTypes && l(n.includeMainTypes,
						s) < 0)) {
					var h = {
						mainType: s
					};
	...
	function Wn(t, e) {
		t.$constructor = t, t.extend = function(t) {
			...
			return o(n.prototype, t), n.extend = this.extend, n.superCall = Gn, n.superApply = Zn, u(n, this), n.superClass =
				e, n
		}
	}
	...
	function Un(t, e) {
		...
		if (t.registerClass = function(t, e) {
				...
				var r = i[t];
				if (r && r[qm] && (r = e ? r[e] : null), n && !r) throw new Error(e ? "Component " + t + "." + (e || "") +
	...
	function $n(t, e, n, i, r, o) {
		var a = i + 3 * (e - n) - t,
			...
			d = l * l - 3 * s * u,
			f = 0;
		if (Xn(h) && Xn(c)) Xn(s) ? o[0] = 0 : (M = -l / s) >= 0 && M <= 1 && (o[f++] = M);
		else {
			var p = c * c - 4 * h * d;
			if (Xn(p)) {
				var g = c / h,
				...
				var v = iv(p),
					y = h * s + 1.5 * a * (-c + v),
					x = h * s + 1.5 * a * (-c - v);
				(M = (-s - ((y = y < 0 ? -nv(-y, sv) : nv(y, sv)) + (x = x < 0 ? -nv(-x, sv) : nv(x, sv)))) / (3 * a)) >= 0 && M <=
					1 && (o[f++] = M)
			} else {
				var _ = (2 * h * s - 3 * a * c) / (2 * iv(h * h * h)),
					w = Math.acos(_) / 3,
					b = iv(h),
					S = Math.cos(w),
					M = (-s - 2 * b * S) / (3 * a),
					m = (-s + b * (S + av * Math.sin(w))) / (3 * a),
	...
	function Kn(t, e, n, i, r) {
		var o = 6 * n - 12 * e + 6 * t,
			...
			s = 3 * e - 3 * t,
			l = 0;
		if (Xn(a)) Yn(o) && (c = -s / o) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var u = o * o - 4 * a * s;
			if (Xn(u)) r[0] = -o / (2 * a);
			else if (u > 0) {
	...
	function Jn(t, e, n, i, r, o, a, s, l, u, h) {
		var c, d, f, p, g, m = .005,
			v = 1 / 0;
		lv[0] = l, lv[1] = u;
		for (var y = 0; y < 1; y += .05) uv[0] = jn(t, n, r, a, y), uv[1] = jn(e, i, o, s, y), (p = cg(lv, uv)) < v && (c =
			y, v = p);
		v = 1 / 0;
		for (var x = 0; x < 32 && !(m < ov); x++) d = c - m, f = c + m, uv[0] = jn(t, n, r, a, d), uv[1] = jn(e, i, o, s, d),
			p = cg(uv, lv), d >= 0 && p < v ? (c = d, v = p) : (hv[0] = jn(t, n, r, a, f), hv[1] = jn(e, i, o, s, f), g = cg(hv,
				lv), f <= 1 && g < v ? (c = f, v = g) : m *= .5);
	...
	function ni(t, e, n, i, r) {
		var o = t - 2 * e + n,
			...
			s = t - i,
			l = 0;
		if (Xn(o)) Yn(a) && (c = -s / a) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var u = a * a - 4 * o * s;
			if (Xn(u))(c = -a / (2 * o)) >= 0 && c <= 1 && (r[l++] = c);
			else if (u > 0) {
				var h = iv(u),
					c = (-a + h) / (2 * o),
					d = (-a - h) / (2 * o);
	...
	function oi(t, e, n, i, r, o, a, s, l) {
		var u, h = .005,
			c = 1 / 0;
		lv[0] = a, lv[1] = s;
		for (var d = 0; d < 1; d += .05) uv[0] = ti(t, n, r, d), uv[1] = ti(e, i, o, d), (m = cg(lv, uv)) < c && (u = d, c =
			m);
		c = 1 / 0;
	...
	function li(t, e, n, i, r, o, a, s, l, u) {
		...
		l[0] = cv(t, l[0]), u[0] = dv(t, u[0]), l[0] = cv(a, l[0]), u[0] = dv(a, u[0]), l[1] = cv(e, l[1]), u[1] = dv(e, u[1]),
			l[1] = cv(s, l[1]), u[1] = dv(s, u[1])
	}
	...
	function hi(t, e, n, i, r, o, a, s, l) {
		...
		if (mv[0] = pv(r) * n + t, mv[1] = fv(r) * i + e, vv[0] = pv(o) * n + t, vv[1] = fv(o) * i + e, u(s, mv, vv), h(l,
				mv, vv), (r %= gv) < 0 && (r += gv), (o %= gv) < 0 && (o += gv), r > o && !a ? o += gv : r < o && a && (r += gv),
			a) {
			var d = o;
			o = r, r = d
		}
		for (var f = 0; f < o; f += Math.PI / 2) f > r && (yv[0] = pv(f) * n + t, yv[1] = fv(f) * i + e, u(s, yv, s), h(l,
			yv, l))
	}
	...
	function di(t, e, n, i, r, o, a, s, l, u, h) {
		if (0 === l) return !1;
		var c = l;
		return !(h > e + c && h > i + c && h > o + c && h > s + c || h < e - c && h < i - c && h < o - c && h < s - c || u >
			t + c && u > n + c && u > r + c && u > a + c || u < t - c && u < n - c && u < r - c && u < a - c) && Jn(t, e, n, i,
			r, o, a, s, u, h, null) <= c / 2
	}

	function fi(t, e, n, i, r, o, a, s, l) {
		if (0 === a) return !1;
		var u = a;
		return !(l > e + u && l > i + u && l > o + u || l < e - u && l < i - u && l < o - u || s > t + u && s > n + u && s >
			r + u || s < t - u && s < n - u && s < r - u) && oi(t, e, n, i, r, o, s, l, null) <= u / 2
	}
	...
	function xi(t, e, n, i, r, o, a, s, l, u) {
		...
		for (var c, d, f = 0, p = -1, g = 0; g < h; g++) {
			var m = Fv[g],
				v = 0 === m || 1 === m ? .5 : 1;
			jn(t, n, r, a, m) < l || (p < 0 && (p = Kn(e, i, o, s, Vv), Vv[1] < Vv[0] && p > 1 && yi(), c = jn(e, i, o, s, Vv[0]),
					p > 1 && (d = jn(e, i, o, s, Vv[1]))), 2 == p ? m < Vv[0] ? f += c < e ? v : -v : m < Vv[1] ? f += d < c ? v : -
				v : f += s < d ? v : -v : m < Vv[0] ? f += c < e ? v : -v : f += s < c ? v : -v)
		}
		return f
	}
		...
		for (var h = 0, c = 0; c < 2; c++) {
			...
			if (d + t > a) {
				var f = Math.atan2(s, d),
					p = o ? 1 : -1;
				f < 0 && (f = Rv + f), (f >= i && f <= r || f + Rv >= i && f + Rv <= r) && (f > Math.PI / 2 && f < 1.5 * Math.PI &&
					(p = -p), h += p)
			}
		}
		return h
			...
			switch (c === Nv.M && h > 1 && (n || (o += mi(a, s, l, u, i, r))), 1 == h && (l = a = t[h], u = s = t[h + 1]), c) {
				...
				case Nv.R:
					...
					var x = l + t[h++],
						_ = u + t[h++];
					if (n) {
						if (ci(l, u, x, u, e, i, r) || ci(x, u, x, _, e, i, r) || ci(x, _, l, _, e, i, r) || ci(l, _, l, u, e, i, r))
							return !0
	...
	function Ti(t, e, n, i, r, o, a, s, l, u, h) {
		var c = l * (Qv / 180),
			d = Kv(c) * (t - n) / 2 + $v(c) * (e - i) / 2,
			f = -1 * $v(c) * (t - n) / 2 + Kv(c) * (e - i) / 2,
			p = d * d / (a * a) + f * f / (s * s);
		p > 1 && (a *= qv(p), s *= qv(p));
		var g = (r === o ? -1 : 1) * qv((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (
				d * d))) || 0,
			m = g * a * f / s,
			v = g * -s * d / a,
			y = (t + n) / 2 + Kv(c) * m - $v(c) * v,
			x = (e + i) / 2 + $v(c) * m + Kv(c) * v,
			_ = ey([1, 0], [(d - m) / a, (f - v) / s]),
			w = [(d - m) / a, (f - v) / s],
			b = [(-1 * d - m) / a, (-1 * f - v) / s],
			S = ey(w, b);
		ty(w, b) <= -1 && (S = Qv), ty(w, b) >= 1 && (S = 0), 0 === o && S > 0 && (S -= 2 * Qv), 1 === o && S < 0 && (S += 2 *
			Qv), h.addData(u, y, x, a, s, _, S, c, o)
	}

	function Ci(t) {
		if (!t) return new Ov;
		for (var e, n = 0, i = 0, r = n, o = i, a = new Ov, s = Ov.CMD, l = t.match(ny), u = 0; u < l.length; u++) {
			for (var h, c = l[u], d = c.charAt(0), f = c.match(iy) || [], p = f.length, g = 0; g < p; g++) f[g] = parseFloat(f[
				g]);
			for (var m = 0; m < p;) {
				...
				switch (d) {
					...
					case "C":
						...
						break;
					case "c":
						h = s.C, a.addData(h, f[m++] + n, f[m++] + i, f[m++] + n, f[m++] + i, f[m++] + n, f[m++] + i), n += f[m - 2], i +=
							f[m - 1];
						break;
					case "S":
						v = n, y = i;
						var T = a.len(),
							C = a.data;
						e === s.C && (v += n - C[T - 4], y += i - C[T - 3]), h = s.C, M = f[m++], I = f[m++], n = f[m++], i = f[m++], a.addData(
							h, v, y, M, I, n, i);
						break;
					case "s":
						v = n, y = i;
						var T = a.len(),
							C = a.data;
						e === s.C && (v += n - C[T - 4], y += i - C[T - 3]), h = s.C, M = n + f[m++], I = i + f[m++], n += f[m++], i +=
							f[m++], a.addData(h, v, y, M, I, n, i);
						break;
					case "Q":
					...
					case "t":
						...
						break;
					case "A":
						x = f[m++], _ = f[m++], w = f[m++], b = f[m++], S = f[m++], Ti(M = n, I = i, n = f[m++], i = f[m++], b, S, x, _,
							w, h = s.A, a);
						break;
					case "a":
						x = f[m++], _ = f[m++], w = f[m++], b = f[m++], S = f[m++], Ti(M = n, I = i, n += f[m++], i += f[m++], b, S, x,
							_, w, h = s.A, a)
				}
			}
	...
	function Oi(t, e, n) {
		var i = t.cpx2,
			r = t.cpy2;
		return null === i || null === r ? [(n ? qn : jn)(t.x1, t.cpx1, t.cpx2, t.x2, e), (n ? qn : jn)(t.y1, t.cpy1, t.cpy2,
			t.y2, e)] : [(n ? ei : ti)(t.x1, t.cpx1, t.x2, e), (n ? ei : ti)(t.y1, t.cpy1, t.y2, e)]
	}
	...
	function Vi(t) {
		var e = t.shape,
			n = t.style.lineWidth;
		return My(2 * e.x1) === My(2 * e.x2) && (e.x1 = e.x2 = Hi(e.x1, n, !0)), My(2 * e.y1) === My(2 * e.y2) && (e.y1 = e.y2 =
			Hi(e.y1, n, !0)), t
	}
	...
	function Wi(t) {
		var e = t.shape,
			...
			o = e.width,
			a = e.height;
		return e.x = Hi(e.x, n, !0), e.y = Hi(e.y, n, !0), e.width = Math.max(Hi(i + o, n, !1) - e.x, 0 === o ? 0 : 1), e.height =
			Math.max(Hi(r + a, n, !1) - e.y, 0 === a ? 0 : 1), t
	}
	...
	function Xi(t) {
		...
		if (e && !t.__highlighted) {
			...
			if (i || !n) {
				var r = t,
					o = t.style;
				n && (o = (r = i.addHover(t)).style), dr(o), n || Ui(r), o.extendFrom(e), Yi(o, e, "fill"), Yi(o, e, "stroke"), cr(
					o), n || (t.dirty(!1), t.z2 += 1)
			}
		}
	}
	...
	function or(t, e, n, i, r, o, a) {
		var s, l = (r = r || Cy).labelFetcher,
			u = r.labelDataIndex,
			h = r.labelDimIndex,
			c = n.getShallow("show"),
			d = i.getShallow("show");
		(c || d) && (l && (s = l.getFormattedLabel(u, "normal", null, h)), null == s && (s = x(r.defaultText) ? r.defaultText(
			u, r) : r.defaultText));
		var f = c ? s : null,
	...
	function ur(t, e, n, i, r, o) {
		n = !r && n || Cy, t.textFill = hr(e.getShallow("color"), i) || n.color, t.textStroke = hr(e.getShallow(
				"textBorderColor"), i) || n.textBorderColor, t.textStrokeWidth = C(e.getShallow("textBorderWidth"), n.textBorderWidth),
			t.insideRawTextPosition = t.textPosition, r || (o && (t.insideRollbackOpt = i, cr(t)), null == t.textFill && (t.textFill =
			...
			t.textLineHeight = e.getShallow("lineHeight"), t.textWidth = e.getShallow("width"), t.textHeight = e.getShallow(
				"height"), t.textTag = e.getShallow("tag"), o && i.disableBox || (t.textBackgroundColor = hr(e.getShallow(
				"backgroundColor"), i), t.textPadding = e.getShallow("padding"), t.textBorderColor = hr(e.getShallow(
	...
	function cr(t) {
		...
		if (e && null == t.textFill) {
			...
			}, t.textFill = "#fff", null == t.textStroke && (t.textStroke = o, null == t.textStrokeWidth && (t.textStrokeWidth =
				2))) : null != o && (n = {
				textFill: null
	...
	function fr(t, e) {
		...
		return L([t.fontStyle || n && n.getShallow("fontStyle") || "", t.fontWeight || n && n.getShallow("fontWeight") || "",
	...
	function pr(t, e, n, i, r, o) {
		if ("function" == typeof r && (o = r, r = null), i && i.isAnimationEnabled()) {
			...
			"function" == typeof u && (u = u(r, i.getAnimationDelayParams ? i.getAnimationDelayParams(e, r) : null)),
				"function" == typeof s && (s = s(r)), s > 0 ? e.animateTo(n, s, u || 0, l, o, !!o) : (e.stopAnimation(), e.attr(n),
					o && o())
	...
	function br(t, e, n) {
		...
		if (n = n || {
				...
				width: 2,
				height: 2
			}, t) return 0 === t.indexOf("image://") ? (i.image = t.slice(8), a(i, n), new an(e)) : Ni(t.replace("path://", ""),
			e, n, "center")
	}
	...
	function Wr(t, e) {
		var n, i = Vr(t),
			r = Math.pow(10, i),
			o = t / r;
		return n = e ? o < 1.5 ? 1 : o < 2.5 ? 2 : o < 4 ? 3 : o < 7 ? 5 : 10 : o < 1 ? 1 : o < 2 ? 2 : o < 3 ? 3 : o < 5 ?
	...
	function jr(t, e, n) {
		...
		return t = t.replace("MM", Yr(a, 2)).replace("M", a).replace("yyyy", o).replace("yy", o % 100).replace("dd", Yr(s, 2))
			.replace("d", s).replace("hh", Yr(l, 2)).replace("h", l).replace("mm", Yr(u, 2)).replace("m", u).replace("ss", Yr(h,
				2)).replace("s", h).replace("SSS", Yr(c, 3))
	}
	...
	function Kr(t, e, n) {
		...
		var i = e.width,
			...
			d = n[1] + n[3],
			f = t.aspect;
		switch (isNaN(u) && (u = i - s - d - o), isNaN(h) && (h = r - l - c - a), null != f && (isNaN(u) && isNaN(h) && (f >
			i / r ? u = .8 * i : h = .8 * r), isNaN(u) && (u = f * h), isNaN(h) && (h = u / f)), isNaN(o) && (o = i - s - u -
			d), isNaN(a) && (a = r - l - h - c), t.left || t.right) {
			case "center":
				o = i / 2 - u / 2 - n[3];
				break;
			case "right":
	...
	function Qr(t, e, n, i, r) {
		...
		if (o || s) {
			var u;
			if ("raw" === l) u = "group" === t.type ? new re(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
	...
	function oo(t) {
		this.fromDataset = t.fromDataset, this.data = t.data || (t.sourceFormat === hx ? {} : []), this.sourceFormat = t.sourceFormat ||
			cx, this.seriesLayoutBy = t.seriesLayoutBy || fx, this.dimensionsDefine = t.dimensionsDefine, this.encodeDefine = t
	...
	function uo(t) {
		...
		if (l) {
			var u = l.option;
			n = u.source, i = gx(l).sourceFormat, r = !0, o = o || u.seriesLayoutBy, null == a && (a = u.sourceHeader), s = s ||
				u.dimensions
		}
		var h = ho(n, i, o, a, s),
			c = e.encode;
	...
	function ho(t, e, n, i, r) {
		...
		if (e === lx) "auto" === i || null == i ? fo(function(t) {
			...
			r[e] = null != t ? t : ""
		}, n, t)), o = r ? r.length : n === px ? t.length : t[0] ? t[0].length : null;
		else if (e === ux) r || (r = po(t), s = !0);
		else if (e === hx) r || (r = [], s = !0, d(t, function(t, e) {
			r.push(e)
		}));
		else if (e === sx) {
			var l = Tn(t[0]);
	...
	function _o(t, e) {
		...
		d(e, function(e, o) {
			"colorLayer" === o && r || ex.hasClass(o) || ("object" == typeof e ? t[o] = t[o] ? i(t[o], e, !1) : n(e) : null ==
				t[o] && (t[o] = e))
		})
	}

	function wo(t) {
		t = t, this.option = {}, this.option[mx] = 1, this._componentsMap = N({
			series: []
		}), this._seriesIndices, this._seriesIndicesMap, _o(t, this._theme.option), i(t, ix, !1), this.mergeOption(t)
	}
	...
	function zo(t) {
		var e = t && t.itemStyle;
		if (e)
			for (var n = 0, r = Ax.length; n < r; n++) {
				var o = Ax[n],
					a = e.normal,
					s = e.emphasis;
				a && a[o] && (t[o] = t[o] || {}, t[o].normal ? i(t[o].normal, a[o]) : t[o].normal = a[o], a[o] = null), s && s[o] &&
					(t[o] = t[o] || {}, t[o].emphasis ? i(t[o].emphasis, s[o]) : t[o].emphasis = s[o], s[o] = null)
			}
	}
	...
	function Eo(t, e, n) {
		if (t && t[e] && (t[e].normal || t[e].emphasis)) {
			var i = t[e].normal,
				r = t[e].emphasis;
			i && (n ? (t[e].normal = t[e].emphasis = null, a(t[e], i)) : t[e] = i), r && (t.emphasis = t.emphasis || {}, t.emphasis[
				e] = r)
		}
	}

	function No(t) {
		Eo(t, "itemStyle"), Eo(t, "lineStyle"), Eo(t, "areaStyle"), Eo(t, "label"), Eo(t, "labelLine"), Eo(t, "upperLabel"),
			Eo(t, "edgeLabel")
	}
	...
	function Fo(t) {
		if (Cx(t)) {
			zo(t), No(t), Ro(t, "label"), Ro(t, "upperLabel"), Ro(t, "edgeLabel"), t.emphasis && (Ro(t.emphasis, "label"), Ro(t
				.emphasis, "upperLabel"), Ro(t.emphasis, "edgeLabel"));
			var e = t.markPoint;
			e && (zo(e), Bo(e));
			var n = t.markLine;
			n && (zo(n), Bo(n));
			...
			if ("graph" === t.type) {
				...
				if (o && !S(o))
					for (s = 0; s < o.length; s++) Bo(o[s]);
				d(t.categories, function(t) {
					No(t)
				})
			}
			if (r && !S(r))
				for (s = 0; s < r.length; s++) Bo(r[s]);
			if ((e = t.markPoint) && e.data)
				for (var a = e.data, s = 0; s < a.length; s++) Bo(a[s]);
			if ((n = t.markLine) && n.data)
				for (var l = n.data, s = 0; s < l.length; s++) y(l[s]) ? (Bo(l[s][0]), Bo(l[s][1])) : Bo(l[s]);
			"gauge" === t.type ? (Ro(t, "axisLabel"), Ro(t, "title"), Ro(t, "detail")) : "treemap" === t.type ? (Eo(t.breadcrumb,
	...
	function Xo(t, e) {
		...
		var n = this._data = t.data,
			i = t.sourceFormat;
		i === dx && (this._offset = 0, this._dimSize = e, this._data = n), o(this, zx[i === lx ? i + "_" + t.seriesLayoutBy :
			i])
	}
	...
	function Qo(t, e) {
		...
		return "time" === n && "number" != typeof t && null != t && "-" !== t && (t = +Br(t)), null == t || "" === t ? NaN :
			+t
	}
	...
	function pa(t, e) {
		if (t && (t.trigger(e), "group" === t.type))
			for (var n = 0; n < t.childCount(); n++) pa(t.childAt(n), e)
	}
	...
	function Ma(t, e, n, i, r) {
		...
		var a = n.overallTask = n.overallTask || ea({
			reset: Ia
		});
		a.context = {
			ecModel: i,
	...
	function Wa(t, e, n, i) {
		var r = e.__inheritedStyle || {},
			a = "text" === e.type;
		if (1 === t.nodeType && (Ga(t, e), o(r, Za(t)), !i))
			for (var s in v_)
				if (v_.hasOwnProperty(s)) {
		...
		var c = e.style;
		null != r.fill && c.set(u, Ha(r.fill, n)), null != r.stroke && c.set(h, Ha(r.stroke, n)), d(["lineWidth", "opacity",
			...
			}), r.lineDash && (e.style.lineDash = L(r.lineDash).split(p_)), c[h] && "none" !== c[h] && (e[h] = !0), e.__inheritedStyle =
			r
	}
		...
		if (n) {
			...
			for (var o = r.length - 1; o > 0; o -= 2) {
				...
				switch (i = i || ft(), s) {
					...
					case "matrix":
						a = L(a).split(p_);
						i[0] = parseFloat(a[0]), i[1] = parseFloat(a[1]), i[2] = parseFloat(a[2]), i[3] = parseFloat(a[3]), i[4] =
							parseFloat(a[4]), i[5] = parseFloat(a[5])
				}
			}
		}
	...
	function ja(t, e, i) {
		...
		this._throttledZrFlush = ya(m(o.flush, o), 17), (e = n(e)) && Lx(e, !0), this._theme = e, this._chartsViews = [],
			this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new Co;
		var a = this._api = ds(this);
		de(U_, r), de(H_, r), this._scheduler = new wa(this, a, H_, U_), pg.call(this, this._ecEventProcessor = new fs),
			this._messageCenter = new Ya, this._initEvents(), this.resize = m(this.resize, this), this._pendingActions = [], o.animation
			.on("frame", this._onframe, this), ns(o, this), O(this)
	}
	...
	function Ja(t, e) {
		...
		I_(h, function(t) {
			d = r.action(t, this._model, this._api), (d = d || o({}, t)).type = s.event || d.type, p.push(d), g ? Ka(this, u,
				t, "series") : l && Ka(this, u, t, l.main, l.sub)
		}, this), "none" === u || g || l || (this[E_] ? ($a(this), B_.update.call(this, t), this[E_] = !1) : B_[u].call(
			this, t)), d = c ? {
			type: s.event || n,
			escapeConnect: i,
			batch: p
	...
	function ns(t, e) {
		t.on("rendered", function() {
			e.trigger("rendered"), !t.animation.isFinished() || e[E_] || e._scheduler.unfinished || e._pendingActions.length ||
				e.trigger("finished")
		})
	}
	...
	function is(t, e, n, i) {
		...
		for (var o = "component" === e, a = o ? t._componentsViews : t._chartsViews, s = o ? t._componentsMap : t._chartsMap,
				l = t._zr, u = t._api, h = 0; h < a.length; h++) a[h].__alive = !1;
		o ? n.eachComponent(function(t, e) {
			"series" !== t && r(e)
		}) : n.eachSeries(r);
		for (h = 0; h < a.length;) {
			var c = a[h];
			c.__alive ? h++ : (!o && c.renderTask.dispose(), l.remove(c.group), c.dispose(n, u), a.splice(h, 1), delete s[c.__id],
	...
	function ss(t, e, n, i, r) {
		...
		e.eachSeries(function(e) {
			...
			n.__alive = !0;
			var s = n.renderTask;
			a.updatePayload(s, i), r && r.get(e.uid) && s.dirty(), o |= s.perform(a.getPerformArgs(s)), n.group.silent = !!e.get(
				"silent"), cs(e, n), hs(e, n)
	...
	function Ls(t) {
		...
		d(t.dimensions, function(e) {
			...
			if (s) {
				var l = n[s];
				n.hasOwnProperty(s) || (l = n[s] = []), l[a.coordDimIndex] = e, a.isExtraCoord || (i.set(s, 1), zs(a.type) && (r[
					0] = e)), a.defaultTooltip && o.push(e)
			}
	...
	function Zs(t, e) {
		var n = t.dimensions,
			i = new uw(f(n, t.getDimensionInfo, t), t.hostModel);
		Rs(i, t);
	...
	function Ys(t, e, i) {
		...
		for (var s = (i.dimsDef || []).slice(), l = N(i.encodeDef), u = N(), h = N(), c = [], f = js(e, t, s, i.dimCount), p =
				0; p < f; p++) {
		...
		l.each(function(t, e) {
			if (1 === (t = Mn(t).slice()).length && t[0] < 0) l.set(e, !1);
			else {
				var n = l.set(e, []);
				d(t, function(t, i) {
		...
		d(t, function(t, e) {
			...
			if (_(t)) i = t, t = {};
				...
				i = t.name;
				var u = t.ordinalMeta;
				t.ordinalMeta = null, (t = n(t)).ordinalMeta = u, o = t.dimsDef, s = t.otherDims, t.name = t.coordDim = t.coordDimIndex =
		...
		var x = i.generateCoord,
			...
			S = null != b;
		b = x ? b || 1 : 0;
		for (var M = x || "value", I = 0; I < f; I++) null == (v = c[I] = c[I] || {}).coordDim && (v.coordDim = qs(M, h, S),
				v.coordDimIndex = 0, (!x || b <= 0) && (v.isExtraCoord = !0), b--), null == v.name && (v.name = qs(v.coordDim, u)),
			null == v.type && vo(e, I, v.name) && (v.type = "ordinal");
		return c
	}
	...
	function ul(t, e) {
		!isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]), ll(t, 0, e), ll(t, 1, e), t[0] > t[1] && (t[0] =
			t[1])
	}
	...
	function hl(t, e, n, i) {
		...
		if (!t) return r;
		e[0] < n[0] && r.push(e[0]);
		for (var o = n[0]; o <= n[1] && (r.push(o), (o = mw(o + t, i)) !== r[r.length - 1]);)
	...
	function pl(t) {
		...
		return d(t, function(t) {
			var n = t.getData(),
				...
				a = Dr(t.get("barWidth"), o),
				s = Dr(t.get("barMaxWidth"), o),
				l = t.get("barGap"),
	...
	function wl(t, e) {
		var n, i, r, o = t.type,
			...
			u = null != s,
			h = t.getExtent();
		"ordinal" === o ? n = e.getCategories().length : (y(i = e.get("boundaryGap")) || (i = [i || 0, i || 0]), "boolean" ==
				typeof i[0] && (i = [0, 0]), i[0] = Dr(i[0], 1), i[1] = Dr(i[1], 1), r = h[1] - h[0] || Math.abs(h[0])), null == a &&
			(a = "ordinal" === o ? n ? 0 : NaN : h[0] - i[0] * r), null == s && (s = "ordinal" === o ? n ? n - 1 : NaN : h[1] +
				i[1] * r), "dataMin" === a ? a = h[0] : "function" == typeof a && (a = a({
				min: h[0],
				max: h[1]
			})), "dataMax" === s ? s = h[1] : "function" == typeof s && (s = s({
				min: h[0],
				max: h[1]
			})), (null == a || !isFinite(a)) && (a = NaN), (null == s || !isFinite(s)) && (s = NaN), t.setBlank(I(a) || I(s) ||
				"ordinal" === o && !t.getOrdinalMeta().categories.length), e.getNeedCrossZero() && (a > 0 && s > 0 && !l && (a = 0),
				a < 0 && s < 0 && !u && (s = 0));
		var c = e.ecModel;
		if (c && "time" === o) {
			var f, p = fl("bar", c);
	...
	function Al(t) {
		...
		if (e.get("axisLabel.show") && !n.isBlank()) {
			...
			for (var c = 0; c < r; c += h) {
				var d = u(i ? i[c] : a[0] + c),
					f = Dl(l.getTextRect(d), l.get("rotate") || 0);
				s ? s.union(f) : s = f
			}
			return s
		}
	...
	function Pl(t, e, n, i, r, o, a) {
		...
		var l;
		return l = 0 === t.indexOf("image://") ? Ri(t.slice(8), new re(e, n, i, r), a ? "center" : "cover") : 0 === t.indexOf(
			"path://") ? Ni(t.slice(7), {}, new re(e, n, i, r), a ? "center" : "cover") : new Zw({
			shape: {
				symbolType: t,
				x: e,
				y: n,
	...
	function Wl(t, e) {
		...
		if (r) return r;
		var o, a;
		if (e.get("show") && !t.scale.isBlank() || (o = []), x(i)) o = $l(t, i, !0);
		else if ("auto" === i) {
	...
	function Yl(t) {
		...
		for (var l = o[0], u = t.dataToCoord(l + 1) - t.dataToCoord(l), h = Math.abs(u * Math.cos(i)), c = Math.abs(u * Math
				.sin(i)), d = 0, f = 0; l <= o[1]; l += s) {
			var p = 0,
				g = 0,
				m = Se(n(l), e.font, "center", "top");
		...
		var x = Math.max(0, Math.floor(Math.min(v, y))),
			...
			b = _.lastTickCount;
		return null != w && null != b && Math.abs(w - x) <= 1 && Math.abs(b - a) <= 1 && w > x ? x = w : (_.lastTickCount =
			a, _.lastAutoInterval = x), x
	}
	...
	function xu(t, e, n, i, r, o, a, s, l, u, h) {
		for (var c = 0, d = n, f = 0; f < i; f++) {
			...
			if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), db(pb, p);
			else if (l > 0) {
				var g = d + o,
					m = e[g];
				if (h)
					for (; m && mu(e[g]);) m = e[g += o];
				var v = .5,
					y = e[c];
				if (!(m = e[g]) || mu(m)) db(gb, p);
				else {
					mu(m) && !h && (m = p), G(fb, m, y);
					var x, _;
					if ("x" === u || "y" === u) {
				...
				ub(pb, pb, s), hb(pb, pb, a), ub(gb, gb, s), hb(gb, gb, a), t.bezierCurveTo(pb[0], pb[1], gb[0], gb[1], p[0], p[1]),
					cb(pb, p, fb, l * v)
			} else t.lineTo(p[0], p[1]);
			c = d, d += o
		}
	...
	function _u(t, e) {
		...
		if (e)
			for (var r = 0; r < t.length; r++) {
				var o = t[r];
				o[0] < n[0] && (n[0] = o[0]), o[1] < n[1] && (n[1] = o[1]), o[0] > i[0] && (i[0] = o[0]), o[1] > i[1] && (i[1] = o[
					1])
			}
		return {
			min: e ? n : i,
	...
	function Iu(t, e, n, i) {
		...
		return e && (f.shape[a ? "width" : "height"] = 0, mr(f, {
			shape: {
				width: u,
				height: h
			}
	...
	function Tu(t, e, n, i) {
		...
		return e && (l.shape.endAngle = -a[0] * s, mr(l, {
			shape: {
				endAngle: -a[1] * s
			}
		}, i)), l
	...
	function Pu(t, e) {
		...
		for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; a < r; a += o)
			if (1.5 * eu.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
		return !0
	}
	...
	function Ru(t, e, n, i) {
		...
		if (l) {
			if (null != u) Bu(a[u]) && (o = a[u]);
			else
				for (var h in a)
					if (a.hasOwnProperty(h) && Bu(a[h]) && !i[r(a[h])]) {
						o = a[h];
						break
					} o && (i[r(o)] = !0)
		}
	...
	function Gu(t, e, n, i) {
		var r, o, a = Nr(n - t.rotation),
			s = i[0] > i[1],
			l = "start" === e && !s || "start" !== e && s;
		return Rr(a - Lb / 2) ? (o = l ? "bottom" : "top", r = "center") : Rr(a - 1.5 * Lb) ? (o = l ? "top" : "bottom", r =
			"center") : (o = "middle", r = a < 1.5 * Lb && a > Lb / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
			rotation: a,
			textAlign: r,
			textVerticalAlign: o
		}
	...
	function Uu(t, e, n) {
		...
		var o = e[0],
			...
			c = n[n.length - 1],
			d = n[n.length - 2];
		!1 === i ? (Xu(o), Xu(u)) : Yu(o, a) && (i ? (Xu(a), Xu(h)) : (Xu(o), Xu(u))), !1 === r ? (Xu(s), Xu(c)) : Yu(l, s) &&
			(r ? (Xu(l), Xu(d)) : (Xu(s), Xu(c)))
	}
	...
	function Yu(t, e, n) {
		...
		if (i && r) {
			var o = pt([]);
			return yt(o, o, -t.rotation), i.applyTransform(mt([], o, t.getLocalTransform())), r.applyTransform(mt([], o, e.getLocalTransform())),
				i.intersect(r)
		}
	}
	...
	function qu(t, e, n) {
		...
		if (e.get("axisTick.show") && !i.scale.isBlank()) {
			for (var r = e.getModel("axisTick"), o = r.getModel("lineStyle"), s = r.get("length"), l = i.getTicksCoords(), u = [],
	...
	function $u(t, e, n) {
		...
		if (T(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
			var r = e.getModel("axisLabel"),
				o = r.get("margin"),
				a = i.getViewLabels(),
				s = (T(n.labelRotate, r.get("rotate")) || 0) * Lb / 180,
				l = Eb(n.rotation, s, n.labelDirection),
				u = e.getCategories(!0),
				h = [],
				c = Zu(e),
			...
			return d(a, function(a, s) {
				...
				ar(x.style, m, {
					...
					}), f && (x.eventData = Hu(e), x.eventData.targetType = "axisLabel", x.eventData.value = g), t._dumbGroup.add(x),
		...
		Nb(n.getCoordinateSystems(), function(n) {
			function s(i, s, l) {
				...
				if (d && ("auto" !== d || i || ah(c))) {
					...
					var f = (c = i ? Ju(l, h, r, e, i, s) : c).get("snap"),
						p = sh(l.model),
	...
	function Ju(t, e, i, r, o, s) {
		var l = e.getModel("axisPointer"),
			u = {};
		Nb(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate",
	...
	function th(t, e) {
		e.eachSeries(function(e) {
			...
			n && "none" !== i && !1 !== i && "item" !== i && !1 !== r && !1 !== e.get("axisPointer.show", !0) && Nb(t.coordSysAxesInfo[
				sh(n.model)], function(t) {
				var i = t.axis;
	...
	function ih(t) {
		...
		if (e) {
			...
			l[0] > l[1] && l.reverse(), (null == a || a > l[1]) && (a = l[1]), a < l[0] && (a = l[0]), r.value = a, s && (r.status =
	...
	function hh(t, e, n) {
		...
		o.labelDirection = o.tickDirection = o.nameDirection = m[s], o.labelOffset = a ? p[d[s]] - p[d.onZero] : 0, e.get(
			"axisTick.inside") && (o.tickDirection = -o.tickDirection), T(n.labelInside, e.get("axisLabel.inside")) && (o.labelDirection = -
			o.labelDirection);
	...
	function Ih(t, e, n, i) {
		var r = n.type,
			o = new(0, ky[r.charAt(0).toUpperCase() + r.slice(1)])(n);
	...
	function kh(t, e, n) {
		var r = o({}, n),
			a = t[e],
			s = n.$action || "merge";
		"merge" === s ? a ? (i(a, r, !0), Jr(a, r, {
			ignoreSize: !0
		}), eo(n, a)) : t[e] = r : "replace" === s ? t[e] = r : "remove" === s && a && (t[e] = null)
	}

	function Ph(t, e) {
		t && (t.hv = e.hv = [Ah(e, ["left", "right"]), Ah(e, ["top", "bottom"])], "group" === t.type && (null == t.width &&
	...
	function Rh(t, e, n) {
		...
		aS(e, function(e, n) {
			var r = e.axisPointerModel.option,
				o = t[n];
			o ? (!e.useHandle && (r.status = "show"), r.value = o.value, r.seriesDataIndices = (o.payloadBatch || []).slice()) :
	...
	function Fh(t, e, n) {
		var i = n.getZr(),
			r = lS(i).axisPointerLastHighlights || {},
			o = lS(i).axisPointerLastHighlights = {};
		aS(t, function(t, e) {
	...
	function Zh(t, e) {
		...
		uS(t).initialized || (uS(t).initialized = !0, n("click", v(Yh, "click")), n("mousemove", v(Yh, "mousemove")), n(
			"globalout", Xh))
	}
	...
	function rc(t, e, n, i) {
		var r = i.getWidth(),
			o = i.getHeight();
		t[0] = Math.min(t[0] + e, r) - e, t[1] = Math.min(t[1] + n, o) - n, t[0] = Math.max(t[0], 0), t[1] = Math.max(t[1],
			0)
	}
	...
	function ac(t, e, n) {
		var i = ft();
		return yt(i, i, n.rotation), vt(i, i, n.position), yr([t.dataToCoord(e), (n.labelOffset || 0) + (n.labelDirection ||
			1) * (n.labelMargin || 0)], i)
	}
	...
	function fc(t) {
		var e = [],
			n = t.get("fontSize"),
			i = t.getTextColor();
		return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) +
			"px"), vS(["decoration", "align"], function(n) {
			var i = t.get(n);
			i && e.push("text-" + n + ":" + i)
		}), e.join(";")
	}
	...
	function pc(t) {
		var e = [],
			...
			o = t.get("padding");
		return n && e.push(dc(n)), i && (Xp.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" +
			Rt(i)), e.push("filter:alpha(opacity=70)"))), vS(["width", "color", "radius"], function(n) {
			var i = "border-" + n,
				r = yS(i),
				o = t.get(r);
	...
	function gc(t, e) {
		...
		var n = document.createElement("div"),
			i = this._zr = e.getZr();
		this.el = n, this._x = e.getWidth() / 2, this._y = e.getHeight() / 2, t.appendChild(n), this._container = t, this._show = !
			1, this._hideTimeout;
		var r = this;
	...
	function vc(t) {
		for (var e = t.pop(); t.length;) {
			var n = t.pop();
			n && (Sr.isInstance(n) && (n = n.get("tooltip", !0)), "string" == typeof n && (n = {
				formatter: n
			}), e = new Sr(n, e, e.ecModel))
		}
		return e
	}
	...
	function Sc(t, e, n) {
		...
		return n.eachComponent("legend", function(n) {
			o && null != i ? n[i ? "select" : "unSelect"](e.name) : (n[t](e.name), i = n.isSelected(e.name)), d(n.getData(),
				function(t) {
					var e = t.get("name");
					if ("\n" !== e && "" !== e) {
	...
	function Oc(t, e, n, i, r, o) {
		var a = [],
			s = Ks(e, i) ? e.getCalculationInfo("stackResultDimension") : i,
			l = Fc(e, s, t),
	...
	function zc(t, e) {
		...
		if (e && !Lc(e) && !y(e.coord) && r) {
			...
			if ((e = n(e)).type && FS[e.type] && a.baseAxis && a.valueAxis) {
				var s = RS(o, a.baseAxis.dim),
					l = RS(o, a.valueAxis.dim);
				...
				for (var u = [null != e.xAxis ? e.xAxis : e.radiusAxis, null != e.yAxis ? e.yAxis : e.angleAxis], h = 0; h < 2; h++)
					FS[u[h]] && (u[h] = Fc(i, i.mapDimension(o[h]), u[h]));
				e.coord = u
			}
		}
		return e
	...
	function Ec(t, e, n, i) {
		...
		return null != t.valueIndex || null != t.valueDim ? (r.valueDataDim = null != t.valueIndex ? e.getDimension(t.valueIndex) :
			t.valueDim, r.valueAxis = n.getAxis(Nc(i, r.valueDataDim)), r.baseAxis = n.getOtherAxis(r.valueAxis), r.baseDataDim =
	...
	function Vc(t, e, n) {
		...
		t.each(function(r) {
			var o, a = t.getItemModel(r),
				s = Dr(a.get("x"), n.getWidth()),
				l = Dr(a.get("y"), n.getHeight());
			if (isNaN(s) || isNaN(l)) {
	...
	function Xc(t, e) {
		var n = e[0],
			i = e[1],
			r = e[2];
		t.x1 = n[0], t.y1 = n[1], t.x2 = i[0], t.y2 = i[1], t.percent = 1, r ? (t.cpx1 = r[0], t.cpy1 = r[1]) : (t.cpx1 =
			NaN, t.cpy1 = NaN)
	}
	...
	function $c(t, e, n, i, r, o) {
		...
		Jc(n.getItemLayout(r)) ? (a ? a.updateData(n, r, o) : a = new t._ctor(n, r, o), n.setItemGraphicEl(r, a), t.group.add(
			a)) : t.group.remove(a)
	}
		...
		if (isNaN(l) || isNaN(u)) {
			...
			if ("cartesian2d" === a.type) {
				var f = a.getAxis("x"),
					p = a.getAxis("y"),
					h = a.dimensions;
				td(t.get(h[0], e)) ? o[0] = f.toGlobalCoord(f.getExtent()[n ? 0 : 1]) : td(t.get(h[1], e)) && (o[1] = p.toGlobalCoord(
					p.getExtent()[n ? 0 : 1]))
			}
		...
		if (isNaN(l) || isNaN(u)) {
			...
			if ("cartesian2d" === a.type) {
				var c = a.getAxis("x"),
					...
					f = t.get(n[0], e),
					p = t.get(n[1], e);
				od(f) ? o[0] = c.toGlobalCoord(c.getExtent()["x0" === n[0] ? 0 : 1]) : od(p) && (o[1] = d.toGlobalCoord(d.getExtent()[
					"y0" === n[1] ? 0 : 1]))
			}
			isNaN(l) || (o[0] = l), isNaN(u) || (o[1] = u)
		} else o = [l, u];
	...
	function fd(t, e) {
		...
		var a = n.getMax(!0);
		return null != a && "dataMax" !== a && "function" != typeof a ? e[1] = a : r && (e[1] = o > 0 ? o - 1 : NaN), n.get(
	...
	function Td(t) {
		...
		pg.call(this), this.setPointerChecker = function(t) {
			...
			}), null == e && (e = !0), !0 !== e && "move" !== e && "pan" !== e || (t.on("mousedown", i), t.on("mousemove", r),
				t.on("mouseup", o)), !0 !== e && "scale" !== e && "zoom" !== e || (t.on("mousewheel", s), t.on("pinch", l))
	...
	function Ad(t) {
		if (!lt(t) && zd("moveOnMouseMove", t, this._opt) && this._dragging && "pinch" !== t.gestureEvent && !Md(this._zr,
				"globalPan")) {
			var e = t.offsetX,
				n = t.offsetY,
				i = this._x,
	...
	function kd(t) {
		var e = zd("zoomOnMouseWheel", t, this._opt),
			n = zd("moveOnMouseWheel", t, this._opt),
			i = t.wheelDelta,
			r = Math.abs(i),
			o = t.offsetX,
			a = t.offsetY;
		if (0 !== i && (e || n)) {
			if (e) {
				...
				Ld(this, "zoom", "zoomOnMouseWheel", t, {
					scale: i > 0 ? s : 1 / s,
					originX: o,
					originY: a
				})
	...
	function Ed(t, e) {
		...
		o.controller.enable(a.controlType, a.opt), o.controller.setPointerChecker(e.containsPoint), xa(o, "dispatchAction",
	...
	function Kd(t) {
		return f(t, function(t) {
			...
			return e.each(e.dimensions, function() {
				for (var t = arguments.length, r = arguments[t - 1], o = e.getName(r), a = 0; a < t - 1; a++) i[a] = arguments[
					a];
	...
	function sf(t) {
		pg.call(this), this._zr = t, this.group = new Jg, this._brushType, this._brushOption, this._panels, this._track = [],
			this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, this._uid =
			"brushController_" + UM++, this._handlers = {}, OM(XM, function(t, e) {
	...
	function Sf(t, e, n, i) {
		var r = i.brushStyle.lineWidth || 0,
			...
			m = p + r,
			v = g + r;
		If(t, e, "main", a, s, p, g), i.transformable && (If(t, e, "w", l, u, o, v), If(t, e, "e", d, u, o, v), If(t, e, "n",
			l, u, m, o), If(t, e, "s", l, f, m, o), If(t, e, "nw", l, u, o, o), If(t, e, "ne", d, u, o, o), If(t, e, "sw", l,
			f, o, o), If(t, e, "se", d, f, o, o))
	}
	...
	function Df(t, e) {
		if (e.length > 1) return ("e" === (i = [Df(t, (e = e.split(""))[0]), Df(t, e[1])])[0] || "w" === i[0]) && i.reverse(),
			i.join("");
		var n = {
				left: "w",
				right: "e",
	...
	function kf(t, e, n, i, r, o, a, s) {
		...
		OM(r.split(""), function(t) {
			var e = HM[t];
			u[e[0]][e[1]] += h[e[0]]
		}), l.range = e(Cf(u[0][0], u[1][0], u[0][1], u[1][1])), pf(n, i), xf(n, {
			isEnd: !1
		})
	}
	...
	function zf(t) {
		var e = EM(t[0][0], t[1][0]),
			n = EM(t[0][1], t[1][1]);
		return {
			x: e,
			y: n,
			width: NM(t[0][0], t[1][0]) - e,
			height: NM(t[0][1], t[1][1]) - n
		}
	}
	...
	function Bf(t, e, i, r) {
		...
		if (t._track.push(i.slice()), _f(t) || a) {
			if (s && !a) {
				...
				var u = n(l);
				u.brushType = Ff(u.brushType, s), u.panelId = !0 === s ? null : s.panelId, a = t._creatingCover = hf(t, u), t._covers
					.push(a)
			}
			if (a) {
				var h = YM[Ff(t._brushType, s)];
				a.__brushOption.range = h.getCreatingRange(Of(t, a, t._track)), r && (cf(t, a), h.updateCommon(t, a)), df(t, a), o = {
					isEnd: r
				}
			}
	...
	function lp(t, e, n, i, r) {
		...
		i && "takeGlobalCursor" === i.type && (o = "dataZoomSelect" === i.key && i.dataZoomSelectActive), n._isZoomActive =
			o, t.setIconStatus("zoom", o ? "emphasis" : "normal");
		var a = new Yf(ap(t.option), e, {
			include: ["grid"]
		});
	...
	function cp() {
		if (!vI && yI) {
			...
			t.length < 31 ? yI.createStyleSheet().addRule(".zrvml", "behavior:url(#default#VML)") : t[0].addRule(".zrvml",
	...
	function fp(t, e) {
		...
		n.style.cssText = "display:inline-block;overflow:hidden;position:relative;width:300px;height:150px;", i.style.cssText =
			"position:absolute;left:0;top:0;", t.appendChild(n), this._vmlRoot = i, this._vmlViewport = n, this.resize();
	...
	function wp(t, e, n) {
		(!n || "linear" !== n.type && "radial" !== n.type) && ("string" == typeof n && n.indexOf("NaN") > -1 && console.log(
	...
	function Sp(t, e, n, i) {
		if (yp(e, n)) {
			...
			r = "transparent" === r ? eT : r, "none" !== t.getAttribute("clip-path") && r === eT && (r = "rgba(0, 0, 0, 0.002)"),
				wp(t, "fill", r), wp(t, "fill-opacity", null != e.fillOpacity ? e.fillOpacity * e.opacity : e.opacity)
		} else wp(t, "fill", eT);
		if (xp(e, n)) {
			var o = n ? e.textStroke : e.stroke;
			wp(t, "stroke", o = "transparent" === o ? eT : o), wp(t, "stroke-width", (n ? e.textStrokeWidth : e.lineWidth) / (!
					n && e.strokeNoScale ? i.getLineScale() : 1)), wp(t, "paint-order", n ? "stroke" : "fill"), wp(t,
					"stroke-opacity", null != e.strokeOpacity ? e.strokeOpacity : e.opacity), e.lineDash ? (wp(t, "stroke-dasharray",
					e.lineDash.join(",")), wp(t, "stroke-dashoffset", nT(e.lineDashOffset || 0))) : wp(t, "stroke-dasharray", ""), e.lineCap &&
				wp(t, "stroke-linecap", e.lineCap), e.lineJoin && wp(t, "stroke-linejoin", e.lineJoin), e.miterLimit && wp(t,
	...
	function Dp(t, e, n, i, r) {
		this._zrId = t, this._svgRoot = e, this._tagNames = "string" == typeof n ? [n] : n, this._markLabel = i, this._domName =
	...
	var Gp = 2311,
		...
		Up = {},
		Xp = Up = "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? {
			browser: {},
			os: {},
			node: !1,
			wxa: !0,
	...
	var ag = (Object.freeze || Object)({
		...
		sg = "undefined" == typeof Float32Array ? Array : Float32Array,
		lg = Z,
		ug = U,
		hg = j,
		cg = q,
		...
		_drag: function(t) {
			...
			if (e) {
				...
				var a = this.findHover(n, i, e).target,
					s = this._dropTarget;
				this._dropTarget = a, e !== a && (s && a !== s && this.dispatchToElement(tt(s, t), "dragleave", t.event), a && a !==
					s && this.dispatchToElement(tt(a, t), "dragenter", t.event))
			}
		},
		_dragEnd: function(t) {
			var e = this._draggingTarget;
			e && (e.dragging = !1), this.dispatchToElement(tt(e, t), "dragend", t.event), this._dropTarget && this.dispatchToElement(
				tt(this._dropTarget, t), "drop", t.event), this._draggingTarget = null, this._dropTarget = null
		}
	};
	var fg = Array.prototype.slice,
		pg = function(t) {
		...
		trigger: function(t) {
			...
			if (e) {
				...
				for (var o = e.length, a = 0; a < o;) {
					var s = e[a];
					if (n && n.filter && null != s.query && !n.filter(t, s.query)) a++;
					else {
						switch (r) {
							case 1:
								s.h.call(s.ctx);
	...
	var xg = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		_g = function(t, e, n, i) {
			pg.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new ct, this.proxy = null, this._hovered = {},
				this._lastTouchMoment, this._lastX, this._lastY, J.call(this), this.setHandlerProxy(n)
		};
	_g.prototype = {
		constructor: _g,
		...
		dispatchToElement: function(t, e, n) {
			var i = (t = t || {}).target;
			if (!i || !i.silent) {
				for (var r = "on" + e, o = ut(e, t, n); i && (i[r] && (o.cancelBubble = i[r].call(i, o)), i.trigger(e, o), i = i
						.parent, !o.cancelBubble););
	...
	var wg = "undefined" == typeof Float32Array ? Array : Float32Array,
	...
	Tg.transform = null, Tg.needLocalTransform = function() {
		return wt(this.rotation) || wt(this.position[0]) || wt(this.position[1]) || wt(this.scale[0] - 1) || wt(this.scale[
			1] - 1)
	};
	var Cg = [];
	Tg.updateTransform = function() {
		var t = this.parent,
			...
			i = this.transform;
		if (n || e) {
			i = i || ft(), n ? this.getLocalTransform(i) : Sg(i), e && (n ? mt(i, t.transform, i) : gt(i, t.transform)), this.transform =
				i;
	...
	Tg.setLocalTransform = function(t) {
		if (t) {
			var e = t[0] * t[0] + t[1] * t[1],
				...
				i = this.position,
				r = this.scale;
			wt(e - 1) && (e = Math.sqrt(e)), wt(n - 1) && (n = Math.sqrt(n)), t[0] < 0 && (e = -e), t[3] < 0 && (n = -n), i[0] =
		...
		if (this.transform) {
			...
			var n = this.origin;
			n && (n[0] || n[1]) && (Dg[4] = n[0], Dg[5] = n[1], mt(Ag, e, Dg), Ag[4] -= n[0], Ag[5] -= n[1], e = Ag), this.setLocalTransform(
				e)
		}
		...
		var n = t.origin,
			...
			r = t.rotation || 0,
			o = t.position || [0, 0];
		return n && (e[4] -= n[0], e[5] -= n[1]), xt(e, e, i), r && yt(e, e, r), n && (e[4] += n[0], e[5] += n[1]), e[4] +=
			o[0], e[5] += o[1], e
	};
	var kg = {
		linear: function(t) {
	...
	var Ng = {
		...
		Wg = (Object.freeze || Object)({
			...
			modifyHSL: function(t, e, n, i) {
				if (t = Ot(t)) return t = Et(t), null != e && (t[0] = Mt(e)), null != n && (t[1] = Ct(n)), null != i && (t[2] =
					Ct(i)), Wt(zt(t), "rgba")
			},
			modifyAlpha: Vt,
			stringify: Wt
		}),
		Hg = Array.prototype.slice,
		Gg = function(t, e, n, i) {
			this._tracks = {}, this._target = t, this._loop = e || !1, this._getter = n || Ht, this._setter = i || Gt, this._clipCount =
	...
	re.prototype = {
		...
		union: function(t) {
			var e = Kg(t.x, this.x),
				n = Kg(t.y, this.y);
			this.width = Qg(t.x + t.width, this.x + this.width) - e, this.height = Qg(t.y + t.height, this.y + this.height) -
				n, this.x = e, this.y = n
		},
			...
			return function(r) {
				if (r) {
					t[0] = n[0] = this.x, t[1] = i[1] = this.y, e[0] = i[0] = this.x + this.width, e[1] = n[1] = this.y + this.height,
						$g(t, t, r), $g(e, e, r), $g(n, n, r), $g(i, i, r), this.x = Kg(t[0], e[0], n[0], i[0]), this.y = Kg(t[1], e[
							1], n[1], i[1]);
					var o = Qg(t[0], e[0], n[0], i[0]),
						a = Qg(t[1], e[1], n[1], i[1]);
	...
	Jg.prototype = {
		...
		remove: function(t) {
			var e = this.__zr,
				...
				i = this._children,
				r = l(i, t);
			return r < 0 ? this : (i.splice(r, 1), t.parent = null, n && (n.delFromStorage(t), t instanceof Jg && t.delChildrenFromStorage(
				n)), e && e.refresh(), this)
		},
		removeAll: function() {
			var t, e, n = this._children,
				i = this.__storage;
			for (e = 0; e < n.length; e++) t = n[e], i && (i.delFromStorage(t), t instanceof Jg && t.delChildrenFromStorage(i)),
				t.parent = null;
	...
	nm.prototype = {
		...
		addRoot: function(t) {
			t.__storage !== this && (t instanceof Jg && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(
				t))
		},
		delRoot: function(t) {
			if (null == t) {
	...
	am.prototype = {
		...
		bind: function(t, e, n) {
			...
			if ((o || i.fill !== r.fill) && (t.fillStyle = i.fill), (o || i.stroke !== r.stroke) && (t.strokeStyle = i.stroke),
				(o || i.opacity !== r.opacity) && (t.globalAlpha = null == i.opacity ? 1 : i.opacity), (o || i.blend !== r.blend) &&
		...
		getGradient: function(t, e, n) {
			for (var i = ("radial" === e.type ? ge : pe)(t, e, n), r = e.colorStops, o = 0; o < r.length; o++) i.addColorStop(
				r[o].offset, r[o].color);
			return i
		}
	};
	...
	var cm = function(t, e, n) {
		...
		var r = i.style;
		r && (i.onselectstart = me, r["-webkit-user-select"] = "none", r["user-select"] = "none", r["-webkit-touch-callout"] =
	...
	cm.prototype = {
		...
		createBackBuffer: function() {
			var t = this.dpr;
			this.domBack = ve("back-" + this.id, this.painter, t), this.ctxBack = this.domBack.getContext("2d"), 1 != t &&
		...
		resize: function(t, e) {
			var n = this.dpr,
				...
				r = i.style,
				o = this.domBack;
			r && (r.width = t + "px", r.height = e + "px"), i.width = t * n, i.height = e * n, o && (o.width = t * n, o.height =
		...
		clear: function(t, e) {
			var n = this.dom,
				...
				l = this.dpr;
			if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(
					n, 0, 0, r / l, o / l)), i.clearRect(0, 0, r, o), e && "transparent" !== e) {
				var u;
				e.colorStops ? (u = e.__canvasGradient || am.getGradient(i, e, {
						...
						width: r,
						height: o
					}), e.__canvasGradient = u) : e.image && (u = hm.prototype.getCanvasPattern.call(e, i)), i.save(), i.fillStyle =
					u || e, i.fillRect(0, 0, r, o), i.restore()
			}
			if (a) {
				var h = this.domBack;
	...
	var dm = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) ||
	...
	Mm.prototype = {
		...
		drawRectText: function(t, e) {
			...
			if (null != i && (i += ""), rn(i, n)) {
				...
				n.transformText ? this.setTransform(t) : r && (Sm.copy(e), Sm.applyTransform(r), e = Sm), He(this, t, i, n, e),
					t.restore()
			}
		}
	}, on.prototype = {
	...
	Cm.prototype = {
		...
		_doPaintEl: function(t, e, n, i) {
			var r = e.ctx,
				o = t.transform;
			if ((e.__dirty || n) && !t.invisible && 0 !== t.style.opacity && (!o || o[0] || o[3]) && (!t.culling || !un(t,
					this._width, this._height))) {
				var a = t.__clipPaths;
				i.prevElClipPaths && !hn(a, i.prevElClipPaths) || (i.prevElClipPaths && (e.ctx.restore(), i.prevElClipPaths =
						null, i.prevEl = null), a && (r.save(), cn(a, r), i.prevElClipPaths = a)), t.beforeBrush && t.beforeBrush(r),
		...
		getLayer: function(t, e) {
			...
			return n || ((n = new cm("zr_" + t, this, this.dpr)).zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && i(n,
		...
		_updateLayerStatus: function(t) {
			...
			if (this.eachBuiltinLayer(function(t, e) {
				...
				var o, a = t[r],
					s = a.zlevel;
				a.incremental ? ((o = this.getLayer(s + .001, this._needsManuallyCompositing)).incremental = !0, i = 1) : o =
					this.getLayer(s + (i > 0 ? .01 : 0), this._needsManuallyCompositing), o.__builtin__ || Yg("ZLevel " + s +
						" has been used by unkown layer " + o.id), o !== n && (o.__used = !0, o.__startIndex !== r && (o.__dirty = !0),
						o.__startIndex = r, o.incremental ? o.__drawIndex = -1 : o.__drawIndex = r, e(r), n = o), a.__dirty && (o.__dirty = !
						0, o.incremental && o.__drawIndex < 0 && (o.__drawIndex = r))
			}
	...
	var Am = function(t) {
		t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !
			1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, pg.call(this)
	};
	Am.prototype = {
		constructor: Am,
		addClip: function(t) {
	...
	var km = {
		...
		Em = {
			...
			touchstart: function(t) {
				(t = ot(this.dom, t)).zrByTouch = !0, this._lastTouchMoment = new Date, mn(this, t, "start"), Em.mousemove.call(
					this, t), Em.mousedown.call(this, t), vn(this)
			},
			touchmove: function(t) {
				(t = ot(this.dom, t)).zrByTouch = !0, mn(this, t, "change"), Em.mousemove.call(this, t), vn(this)
			},
			touchend: function(t) {
				(t = ot(this.dom, t)).zrByTouch = !0, mn(this, t, "end"), Em.mouseup.call(this, t), +new Date - this._lastTouchMoment <
					300 && Em.click.call(this, t), vn(this)
			},
	...
	var Rm = !Xp.canvasSupported,
		...
		Vm = function(t, e, n) {
			...
			this.handler = new _g(r, a, s, a.root), this.animation = new Am({
				stage: {
	...
	Vm.prototype = {
		...
		dispose: function() {
			this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this
				.animation = this.storage = this.painter = this.handler = null, Sn(this.id)
		}
	};
	var Wm = (Object.freeze || Object)({
		...
		Zm = y,
		Um = "series\0",
		Xm = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor",
		...
		Ym = 0,
		jm = ".",
		qm = "___EC__COMPONENT__CONTAINER___",
		$m = 0,
		Km = function(t) {
		...
		kv = Math.sqrt,
		Pv = Math.abs,
		Lv = "undefined" != typeof Float32Array,
		Ov = function(t) {
	...
	Ov.prototype = {
		...
		moveTo: function(t, e) {
			return this.addData(wv.M, t, e), this._ctx && this._ctx.moveTo(t, e), this._x0 = t, this._y0 = e, this._xi = t,
				this._yi = e, this
		},
		lineTo: function(t, e) {
			var n = Pv(t - this._xi) > this._ux || Pv(e - this._yi) > this._uy || this._len < 5;
			return this.addData(wv.L, t, e), this._ctx && n && (this._needsDash() ? this._dashedLineTo(t, e) : this._ctx.lineTo(
				t, e)), n && (this._xi = t, this._yi = e), this
		},
		bezierCurveTo: function(t, e, n, i, r, o) {
			return this.addData(wv.C, t, e, n, i, r, o), this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, n, i, r,
				o) : this._ctx.bezierCurveTo(t, e, n, i, r, o)), this._xi = r, this._yi = o, this
		},
		quadraticCurveTo: function(t, e, n, i) {
			return this.addData(wv.Q, t, e, n, i), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(t, e, n, i) :
				this._ctx.quadraticCurveTo(t, e, n, i)), this._xi = n, this._yi = i, this
		},
		arc: function(t, e, n, i, r, o) {
			return this.addData(wv.A, t, e, n, n, i, r - i, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, o), this
				._xi = Av(r) * n + t, this._yi = Dv(r) * n + e, this
		},
		...
		_dashedLineTo: function(t, e) {
			var n, i, r = this._dashSum,
				...
				p = u,
				g = a.length;
			for (h /= d, c /= d, o < 0 && (o = r + o), f -= (o %= r) * h, p -= o * c; h > 0 && f <= t || h < 0 && f >= t || 0 ==
				h && (c > 0 && p <= e || c < 0 && p >= e);) f += h * (n = a[i = this._dashIdx]), p += c * n, this._dashIdx = (i +
				1) % g, h > 0 && f < l || h < 0 && f > l || c > 0 && p < u || c < 0 && p > u || s[i % 2 ? "moveTo" : "lineTo"](
				h >= 0 ? Tv(f, t) : Cv(f, t), c >= 0 ? Tv(p, e) : Cv(p, e));
		...
		_dashedBezierTo: function(t, e, n, i, r, o) {
			var a, s, l, u, h, c = this._dashSum,
				...
				_ = f.length,
				w = 0;
			for (d < 0 && (d = c + d), d %= c, a = 0; a < 1; a += .1) s = v(g, t, n, r, a + .1) - v(g, t, n, r, a), l = v(m,
				e, i, o, a + .1) - v(m, e, i, o, a), y += kv(s * s + l * l);
			for (; x < _ && !((w += f[x]) > d); x++);
				...
				switch (1 == o && (i = e = t[o], r = n = t[o + 1]), a) {
					...
					case wv.A:
						var s = t[o++],
							...
							d = t[o++] + c,
							f = (t[o++], 1 - t[o++]);
						1 == o && (i = Av(c) * u + s, r = Dv(c) * h + l), hi(s, l, u, h, c, d, f, Mv, Iv), e = Av(d) * u + s, n = Dv(d) *
							h + l;
						break;
					case wv.R:
				...
				switch (1 == c && (e = i = s[c], n = r = s[c + 1]), d) {
					...
					case wv.A:
						...
						Math.abs(g - m) > .001 ? (t.translate(f, p), t.rotate(x), t.scale(b, S), t.arc(0, 0, w, v, M, 1 - _), t.scale(
							1 / b, 1 / S), t.rotate(-x), t.translate(-f, -p)) : t.arc(f, p, w, v, M, 1 - _), 1 == c && (e = Av(v) * g +
							f, n = Dv(v) * m + p), i = Av(M) * g + f, r = Dv(M) * m + p;
						break;
					case wv.R:
	...
	var zv = 2 * Math.PI,
		...
		Fv = [-1, -1, -1],
		Vv = [-1, -1],
		Wv = hm.prototype.getCanvasPattern,
		Hv = Math.abs,
		Gv = new Ov(!0);
	Ii.prototype = {
		constructor: Ii,
		...
		brush: function(t, e) {
			...
			if (n.bind(t, this, e), this.setTransform(t), this.__dirty) {
				var d;
				l && (d = d || this.getBoundingRect(), this._fillGradient = n.getGradient(t, a, d)), u && (d = d || this.getBoundingRect(),
					this._strokeGradient = n.getGradient(t, s, d))
			}
			l ? t.fillStyle = this._fillGradient : h && (t.fillStyle = Wv.call(a, t)), u ? t.strokeStyle = this._strokeGradient :
				c && (t.strokeStyle = Wv.call(s, t));
			var f = n.lineDash,
				p = n.lineDashOffset,
				g = !!t.setLineDash,
				m = this.getGlobalScale();
			if (i.setScale(m[0], m[1]), this.__dirtyPath || f && !g && r ? (i.beginPath(t), f && !g && (i.setLineDash(f), i.setLineDashOffset(
		...
		getBoundingRect: function() {
			...
			if (this._rect = t, e.hasStroke()) {
				...
				if (this.__dirty || n) {
					...
					e.hasFill() || (o = Math.max(o, this.strokeContainThreshold || 4)), a > 1e-10 && (r.width += o / a, r.height +=
						o / a, r.x -= o / a / 2, r.y -= o / a / 2)
				}
				return r
			}
			return t
		...
		attrKV: function(t, e) {
			"shape" === t ? (this.setShape(e), this.__dirtyPath = !0, this._rect = null) : on.prototype.attrKV.call(this, t,
				e)
		},
			...
			for (r = 0, o = 0; r < l.length;) {
				switch (n = l[r++], o = r, i = 0, n) {
					...
					case f:
						...
						break;
					case d:
						s[0] = l[r++], s[1] = l[r++], $(s, s, e), l[o++] = s[0], l[o++] = s[1], s[0] += l[r++], s[1] += l[r++], $(s, s,
							e), l[o++] = s[0], l[o++] = s[1]
				}
	...
	ry.prototype = {
		...
		brush: function(t, e) {
			var n = this.style;
			this.__dirty && Ve(n), n.fill = n.stroke = n.shadowBlur = n.shadowColor = n.shadowOffsetX = n.shadowOffsetY =
				null;
			var i = n.text;
		...
		sy = function(t) {
			return Xp.browser.ie && Xp.browser.version >= 11 ? function() {
				...
				if (t.apply(this, arguments), e)
					for (var l = 0; l < ay.length; l++) i[ay[l][0]] = ay[l][2]
			} : t
		},
		ly = Ii.extend({
			type: "sector",
			...
			buildPath: function(t, e) {
				var n = e.cx,
					...
					u = Math.cos(a),
					h = Math.sin(a);
				t.moveTo(u * r + n, h * r + i), t.lineTo(u * o + n, h * o + i), t.arc(n, i, o, a, s, !l), t.lineTo(Math.cos(s) *
					r + n, Math.sin(s) * r + i), 0 !== r && t.arc(n, i, r, s, a, l), t.closePath()
			}
		}),
		uy = Ii.extend({
			type: "ring",
		...
		vy = Ii.extend({
			...
			buildPath: function(t, e) {
				var n = e.x1,
					...
					u = e.cpy2,
					h = e.percent;
				0 !== h && (t.moveTo(n, i), null == l || null == u ? (h < 1 && (ri(n, a, r, h, my), a = my[1], r = my[2], ri(i,
					s, o, h, my), s = my[1], o = my[2]), t.quadraticCurveTo(a, s, r, o)) : (h < 1 && (Qn(n, a, l, r, h, my), a =
					my[1], l = my[2], r = my[3], Qn(i, s, u, o, h, my), s = my[1], u = my[2], o = my[3]), t.bezierCurveTo(a, s,
					l, u, r, o)))
			},
			pointAt: function(t) {
	...
	var wy = function(t, e, n, i, r, o) {
		this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i,
			this.type = "linear", this.global = o || !1, _y.call(this, r)
	};
	wy.prototype = {
		constructor: wy
	}, u(wy, _y);
	...
	by.prototype = {
		constructor: by
	}, u(by, _y), zi.prototype.incremental = !0, zi.prototype.clearDisplaybles = function() {
	...
	var My = Math.round,
		...
		Ly = {
			...
			getTextRect: function(t) {
				return Se(t, this.getFont(), this.getShallow("align"), this.getShallow("verticalAlign") || this.getShallow(
	...
	var Ry = 0,
		...
		Vy = (Object.freeze || Object)({
			...
			reformIntervals: function(t) {
				function e(t, n, i) {
					return t.interval[i] < n.interval[i] || t.interval[i] === n.interval[i] && (t.close[i] - n.close[i] == (i ? -1 :
						1) || !i && e(t, n, 1))
				}
				t.sort(function(t, n) {
					return e(t, n, 0) ? -1 : 1
				...
				for (var n = -1 / 0, i = 1, r = 0; r < t.length;) {
					for (var o = t[r].interval, a = t[r].close, s = 0; s < 2; s++) o[s] <= n && (o[s] = n, a[s] = s ? 1 : 1 - i), n =
						o[s], i = a[s];
	...
	var ix = {
		...
		ax = {
			cartesian2d: function(t, e, n, i) {
				...
				e.coordSysDims = ["x", "y"], n.set("x", r), n.set("y", o), ro(r) && (i.set("x", r), e.firstCategoryDimIndex = 0),
					ro(o) && (i.set("y", o), e.firstCategoryDimIndex = 1)
			},
			...
			polar: function(t, e, n, i) {
				...
				e.coordSysDims = ["radius", "angle"], n.set("radius", o), n.set("angle", a), ro(o) && (i.set("radius", o), e.firstCategoryDimIndex =
					0), ro(a) && (i.set("angle", a), e.firstCategoryDimIndex = 1)
			},
	...
	h(vx, ox);
	var yx = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on",
	...
	Ao.prototype = {
		...
		setOption: function(t, e) {
			...
			var n = this._optionBackup,
				i = Do.call(this, t, e, !n);
			this._newBaseOption = i.baseOption, n ? (Oo(n.baseOption, i.baseOption), i.timelineOptions.length && (n.timelineOptions =
		...
		mountOption: function(t) {
			...
			return this._timelineOptions = Sx(e.timelineOptions, bx), this._mediaList = Sx(e.mediaList, bx), this._mediaDefault =
				bx(e.mediaDefault), this._currentMediaIndices = [], bx(t ? e.baseOption : this._newBaseOption)
		},
	...
	var Tx = d,
		Cx = w,
		Ax = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
		Dx = function(t, e) {
	...
	var zx = {
		...
		Nx = {
			...
			original: function(t, e, n, i) {
				...
				return !this._rawData.pure && Cn(t) && (this.hasItemOption = !0), Qo(r instanceof Array ? r[i] : r, this._dimensionInfos[
					e])
			},
	...
	Fx.perform = function(t) {
		...
		if (this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			...
			if (!i && (h || d < f)) {
				...
				if (y(p))
					for (var g = 0; g < p.length; g++) ia(this, p[g], d, f, l, u);
				else ia(this, p, d, f, l, u)
			}
			this._dueIndex = f;
		...
		Hx = ex.extend({
			...
			mergeDefaultAndTheme: function(t, e) {
				var n = this.layoutMode,
					r = n ? to(t) : {},
					o = this.subType;
				ex.hasClass(o) && (o += "Series"), i(t, e.getTheme().get(this.subType)), i(t, this.getDefaultOption()), In(t,
					"label", ["show"]), this.fillDataTextStyle(t.data), n && Jr(t, r, n)
			},
			mergeOption: function(t, e) {
			...
			fillDataTextStyle: function(t) {
				if (t && !S(t))
					for (var e = ["show"], n = 0; n < t.length; n++) t[n] && t[n].label && In(t[n], "label", e)
			},
			...
			formatTooltip: function(t, e, n, i) {
				...
				var x = (f > 1 || m && !f ? function(n) {
						function r(t, n) {
							...
							if (r && !1 !== r.otherDims.tooltip) {
								var c = r.type,
									...
									m = (a ? g + Zr(r.displayName || "-") + ": " : "") + Zr("ordinal" === c ? t + "" : "time" === c ? e ? "" :
										jr("yyyy/MM/dd hh:mm:ss", t) : Hr(t));
					...
					}(g) : r(f ? Jo(h, t, c[0]) : m ? g[0] : g)).content,
					_ = o.seriesIndex + "at" + u,
					b = Xr({
						color: v,
						type: "item",
						renderMode: i,
			...
			getColorFromPalette: function(t, e, n) {
				var i = this.ecModel,
					r = ox.getColorFromPalette.call(this, t, e, n);
	...
	var Zx = Gx.prototype;
	Zx.updateView = Zx.updateLayout = Zx.updateVisual = function(t, e, n, i) {}, Wn(Gx), Un(Gx, {
		registerWhenExtend: !0
	});
	var Ux = function() {
			var t = On();
	...
	jx.updateView = jx.updateLayout = jx.updateVisual = function(t, e, n, i) {
		...
		registerWhenExtend: !0
	}), fa.markUpdateMethod = function(t, e) {
		Xx(t).updateMethod = e
	};
	var qx = {
			...
			if (o.get("show"))
				if (o.get("description")) t.setAttribute("aria-label", o.get("description"));
					...
					if (!(a < 1)) {
						...
						}), s += f.join(i("series.multiple.separator.middle")) + i("series.multiple.separator.end"), t.setAttribute(
							"aria-label", s)
					}
				}
		},
	...
	i_.restoreData = function(t, e) {
		...
		ba(this, this._dataProcessorHandlers, t, e, {
			block: !0
		})
	...
	var u_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1",
		...
		h_ = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], u_
			]
		},
		c_ = ["#dd6b66", "#759aa0", "#e69d87", "#8dc1a9", "#ea7e53", "#eedd78", "#73a373", "#73b9bc", "#7289ab", "#91ca8c",
			"#f49f42"
		],
		d_ = {
			color: c_,
	...
	var f_ = Ii.extend({
			...
			buildPath: function(t, e) {
				var n = .5522848,
					...
					s = o * n,
					l = a * n;
				t.moveTo(i - o, r), t.bezierCurveTo(i - o, r - l, i - s, r - a, i, r - a), t.bezierCurveTo(i + s, r - a, i + o,
					r - l, i + o, r), t.bezierCurveTo(i + o, r + l, i + s, r + a, i, r + a), t.bezierCurveTo(i - s, r + a, i - o,
					r + l, i - o, r), t.closePath()
			}
		}),
		p_ = /[\s,]+/;
	...
	R_._onframe = function() {
			if (!this._disposed) {
				...
				if (this[E_]) {
					...
					do {
						var r = +new Date;
						t.performSeriesTasks(i), t.performDataProcessorTasks(i), Qa(this, i), t.performVisualTasks(i), ss(this, this._model,
			...
			if (C_(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[z_] = !0, !this._model || e) {
				var r = new Ao(this._api),
					o = this._theme,
					a = this._model = new vx(null, null, o, r);
				a.scheduler = this._scheduler, a.init(null, null, o, r)
			}
			this._model.setOption(t, G_), n ? (this[E_] = {
				silent: i
			}, this[z_] = !1) : ($a(this), B_.update.call(this), this._zr.flush(), this[E_] = !1, this[z_] = !1, ts.call(this,
				i), es.call(this, i))
			...
			if (Xp.canvasSupported) return (t = t || {}).pixelRatio = t.pixelRatio || 1, t.backgroundColor = t.backgroundColor ||
			...
			var o = "svg" === this._zr.painter.getType() ? this.getSvgDataUrl() : this.getRenderedCanvas(t).toDataURL("image/" +
				(t && t.type || "png"));
		...
		}, R_.convertToPixel = v(qa, "convertToPixel"), R_.convertFromPixel = v(qa, "convertFromPixel"), R_.containPixel =
		function(t, e) {
			var n;
	...
	var B_ = {
		...
		update: function(t) {
			var e = this._model,
				...
				o = this._scheduler;
			if (e) {
				o.restoreData(e, t), o.performSeriesTasks(e), r.create(e, n), o.performDataProcessorTasks(e, t), Qa(this, e), r.update(
					e, n), rs(e), o.performVisualTasks(e, t), os(this, e, n, t);
				var a = e.get("backgroundColor") || "transparent";
				if (Xp.canvasSupported) i.setBackgroundColor(a);
				else {
					var s = Ot(a);
		...
		updateView: function(t) {
			var e = this._model;
			e && (fa.markUpdateMethod(t, "updateView"), rs(e), this._scheduler.performVisualTasks(e, t, {
				setDirty: !0
			}), os(this, this._model, this._api, t), ls(e, this._api))
		},
	...
	R_.resize = function(t) {
		...
		C_(e) || (e = {
			silent: !!e
		}), V_[t.type] && this._model && (this[z_] ? this._pendingActions.push(t) : (Ja.call(this, t, e.silent), e.flush ?
			this._zr.flush(!0) : !1 !== e.flush && Xp.browser.weChat && this._throttledZrFlush(), ts.call(this, e.silent),
			es.call(this, e.silent)))
	...
	var F_ = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout",
		"contextmenu"
	];
	R_._initEvents = function() {
		...
		filter: function(t, e, n) {
			...
			var u = e.cptQuery,
				h = e.dataQuery;
			return i(u, s, "mainType") && i(u, s, "subType") && i(u, s, "index", "componentIndex") && i(u, s, "name") && i(u,
				s, "id") && i(h, a, "name") && i(h, a, "dataIndex") && i(h, a, "dataType") && (!l.filterForExposedEvent || l.filterForExposedEvent(
				t, e.otherQuery, o, a))
		},
	...
	ks.prototype = {
		...
		execute: function() {
			var t = this._old,
				...
				i = [],
				r = [];
			for (Ps(t, {}, i, "_oldKeyGetter", this), Ps(e, n, r, "_newKeyGetter", this), o = 0; o < t.length; o++) null != (
				s = n[a = i[o]]) ? ((u = s.length) ? (1 === u && (n[a] = null), s = s.unshift()) : n[a] = null, this._update &&
				this._update(s, o)) : this._remove && this._remove(o);
	...
	var ew = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		nw = w,
		iw = "e\0\0",
		rw = {
		...
		sw = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_chunkSize", "_chunkCount",
			"_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx"
		],
		lw = ["_extent", "_approximateExtent", "_rawExtent"],
		uw = function(t, e) {
			t = t || ["x", "y"];
			for (var n = {}, i = [], r = {}, o = 0; o < t.length; o++) {
				...
				var s = a.name;
				a.type = a.type || "float", a.coordDim || (a.coordDim = s, a.coordDimIndex = 0), a.otherDims = a.otherDims || {},
					i.push(s), n[s] = a, a.index = o, a.createInvertedIndices && (r[s] = [])
			}
			this.dimensions = i, this._dimensionInfos = n, this.hostModel = e, this.dataType, this._indices = null, this._count =
				...
				this._dimensionsSummary = Ls(this), this._invertedIndicesMap = r, this._calculationInfo = {}
		},
		hw = uw.prototype;
	hw.type = "list", hw.hasItemOption = !0, hw.getDimension = function(t) {
		...
		(oo.isInstance(t) || c(t)) && (t = new Xo(t, this.dimensions.length)), this._rawData = t, this._storage = {}, this._indices =
			null, this._nameList = e || [], this._idList = [], this._nameRepeatCount = {}, n || (this.hasItemOption = !1),
			this.defaultDimValueGetter = Nx[this._rawData.getSource().sourceFormat], this._dimValueGetter = n = n || this.defaultDimValueGetter,
		...
		if (!(t >= e)) {
			for (var n, i = this._chunkSize, r = this._rawData, o = this._storage, a = this.dimensions, s = a.length, l = this
		...
		if (t) {
			...
			for (var i = new(e = Es(this))(this.count()), r = 0; r < i.length; r++) i[r] = r;
		return i
	}, hw.get = function(t, e) {
		...
		if (this._count) {
			...
			return l < r && (this._indices = o), this._count = l, this._extent = {}, this.getRawIndex = this._indices ? Ws :
				Vs, this
		}
		...
		if (this._count) {
			...
			if (i) {
				...
				return a < r && (this._indices = o), this._count = a, this._extent = {}, this.getRawIndex = this._indices ? Ws :
					Vs, this
			}
		}
		...
		for (var o = r._storage, a = [], s = this._chunkSize, l = t.length, u = this.count(), h = [], c = r._rawExtent, d =
				0; d < u; d++) {
		...
		for (var r = Zs(this, [t]), o = r._storage, a = [], s = Math.floor(1 / e), l = o[t], u = this.count(), h = this._chunkSize,
				c = r._rawExtent[t], d = new(Es(this))(u), f = 0, p = 0; p < u; p += s) {
	...
	}, hw.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], hw.CHANGABLE_METHODS = ["filterSelf",
		"selectRange"
	];
	var dw = function(t, e) {
	...
	nl.prototype.parse = function(t) {
		...
		this._isBlank = t
	}, nl.prototype.getLabel = null, Wn(nl), Un(nl, {
		registerWhenExtend: !0
	}), il.createByAxisModel = function(t) {
		var e = t.option,
			n = e.data,
			i = n && f(n, ol);
		return new il({
		...
		ww = {
			...
			reset: function(t) {
				if (vl(t) && yl(t)) {
					...
					return u > .5 || (u = .5), {
						progress: function(t, e) {
							for (var i, h = new _w(2 * t.count), c = [], d = [], f = 0; null != (i = t.next());) d[l] = e.get(o, i), d[1 -
								l] = e.get(a, i), c = n.dataToPoint(d, null, c), h[f++] = c[0], h[f++] = c[1];
							e.setLayout({
								largePoints: h,
								barWidth: u,
								valueAxisStart: xl(0, r),
		...
		Vw = Ei({
			...
			buildPath: function(t, e) {
				var n = e.x,
					...
					f = .6 * a,
					p = .7 * a;
				t.moveTo(n - h, l + s), t.arc(n, l, a, Math.PI - u, 2 * Math.PI + u), t.bezierCurveTo(n + h - c * f, l + s + d *
	...
	var Zw = Ei({
			...
			buildPath: function(t, e, n) {
				var i = e.symbolType,
					r = Gw[i];
				"none" !== e.symbolType && (r || (r = Gw[i = "rect"]), Hw[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(
					t, r.shape, n))
			}
		}),
		Uw = {
			isDimensionStacked: Ks,
			enableDataStack: $s,
	...
	zl.prototype = {
		...
		transformTo: function(t, e, n, i) {
			var r = this.getBoundingRect(),
				o = r.width / r.height;
			n ? i || (i = n / o) : n = o * i;
			for (var a = new re(t, e, n, i), s = r.calculateTransform(a), l = this.geometries, u = 0; u < l.length; u++)
				if ("polygon" === l[u].type) {
	...
	var eb = eu.prototype,
		nb = eu.getSymbolSize = function(t, e) {
	...
	eb._createSymbol = function(t, e, n, i, r) {
		...
		o.attr({
			...
			culling: !0,
			scale: nu(i)
		}), o.drift = iu, this._symbolType = t, this.add(o)
		...
		if (this._updateCommon(t, e, o, n), a) {
			...
			}), l.scale = [0, 0], u && (l.style.opacity = 0), mr(l, h, r, e)
		}
		this._seriesModel = r
	};
	var ib = ["itemStyle"],
		rb = ["emphasis", "itemStyle"],
		ob = ["label"],
		ab = ["emphasis", "label"];
	eb._updateCommon = function(t, e, n, i) {
		...
		if (!i || t.hasItemOption) {
			...
			l = m.getModel(ib).getItemStyle(["color"]), u = m.getModel(rb).getItemStyle(), h = m.getShallow("symbolRotate"), c =
				m.getShallow("symbolOffset"), d = m.getModel(ob), f = m.getModel(ab), p = m.getShallow("hoverAnimation"), g = m.getShallow(
					"cursor")
		} else u = o({}, u);
		var v = r.style;
		r.attr("rotation", (h || 0) * Math.PI / 180 || 0), c && r.attr("position", [Dr(c[0], n[0]), Dr(c[1], n[1])]), g &&
		...
		or(v, u, d, f, {
				...
				isRectText: !0,
				autoColor: s
			}), r.off("mouseover").off("mouseout").off("emphasis").off("normal"), r.hoverStyle = u, ir(r), r.__symbolOriginalScale =
			nu(n), p && a.isAnimationEnabled() && r.on("mouseover", ru).on("mouseout", ou).on("emphasis", au).on("normal", su)
	...
	sb.updateData = function(t, e) {
		...
		r || n.removeAll(), t.diff(r).add(function(i) {
			...
			var u = r.getItemGraphicEl(l),
				h = t.getItemLayout(s);
			uu(t, h, s, e) ? (u ? (u.updateData(t, s, a), gr(u, {
				position: h
	...
	var lb = function(t, e, n, i, r, o, a, s) {
			for (var l = gu(t, e), u = [], h = [], c = [], d = [], f = [], p = [], g = [], m = du(r, e, a), v = du(o, t, s), y =
					0; y < l.length; y++) {
				var x = l[y],
					_ = !0;
				switch (x.cmd) {
					...
					case "+":
						S = x.idx;
						u.push(r.dataToPoint([e.get(m.dataDimsForPoint[0], S), e.get(m.dataDimsForPoint[1], S)])), h.push(e.getItemLayout(
							S).slice()), c.push(pu(m, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
						break;
					case "-":
						var S = x.idx,
							M = t.getRawIndex(S);
						M !== S ? (u.push(t.getItemLayout(S)), h.push(o.dataToPoint([t.get(v.dataDimsForPoint[0], S), t.get(v.dataDimsForPoint[
							1], S)])), c.push(n[S]), d.push(pu(v, o, t, S)), g.push(M)) : _ = !1
				}
		...
		vb = Ii.extend({
			...
			buildPath: function(t, e) {
				var n = e.points,
					...
					o = n.length,
					a = e.smoothMonotone,
					s = _u(n, e.smoothConstraint),
					l = _u(i, e.smoothConstraint);
				if (e.connectNulls) {
					for (; o > 0 && mu(n[o - 1]); o--);
					for (; r < o && mu(n[r]); r++);
				}
	...
	fa.extend({
		...
		render: function(t, e, n) {
			...
			var S = !h && t.get("step");
			f && c.type === i.type && S === this._step ? (v && !p ? p = this._newPolygon(u, x, i, m) : p && !v && (g.remove(
				p), p = this._polygon = null), g.setClipPath(Cu(i, !1, !1, t)), _ && d.updateData(o, {
				isIgnore: w,
				clipShape: Cu(i, !1, !0, t)
			}), o.eachItemGraphicEl(function(t) {
				t.stopAnimation(!0)
			}), wu(this._stackedOnPoints, x) && wu(this._points, u) || (m ? this._updateAnimation(o, x, i, n, S, y) : (S &&
				(u = Au(u, i, S), x = Au(x, i, S)), f.setShape({
					points: u
				}), p && p.setShape({
					points: u,
					stackedOnPoints: x
				...
				isIgnore: w,
				clipShape: Cu(i, !1, !0, t)
			}), S && (u = Au(u, i, S), x = Au(x, i, S)), f = this._newPolyline(u, i, m), v && (p = this._newPolygon(u, x,
				i, m)), g.setClipPath(Cu(i, !0, !1, t)));
			...
			this._data = o, this._coordSys = i, this._stackedOnPoints = x, this._points = u, this._step = S, this._valueOrigin =
				y
		},
		dispose: function() {},
		highlight: function(t, e, n, i) {
			...
			if (!(o instanceof Array) && null != o && o >= 0) {
				...
				if (!a) {
					...
					if (!s) return;
					(a = new eu(r, o)).position = s, a.setZ(t.get("zlevel"), t.get("z")), a.ignore = isNaN(s[0]) || isNaN(s[1]), a
						.__temp = !0, r.setItemGraphicEl(o, a), a.stopSymbolAnimation(!0), this.group.add(a)
				}
				a.highlight()
		...
		_updateAnimation: function(t, e, n, i, r, o) {
			var a = this._polyline,
				s = this._polygon,
				l = t.hostModel,
				u = lb(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o),
				h = u.current,
				c = u.stackedOnCurrent,
				d = u.next,
				f = u.stackedOnNext;
			r && (h = Au(u.current, n, r), c = Au(u.stackedOnCurrent, n, r), d = Au(u.next, n, r), f = Au(u.stackedOnNext, n,
				r)), a.shape.__points = u.current, a.shape.points = h, gr(a, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
						...
						return {
							dataEach: o.hasItemOption || u ? function(e, n) {
								...
								if (e.hasItemOption) {
									...
									null != a && e.setItemVisual(n, "symbol", a), null != l && e.setItemVisual(n, "symbolSize", l), null != u &&
										e.setItemVisual(n, "symbolKeepAspect", u)
								}
							} : null
						}
					}
	...
	bb.prototype = {
		...
		clampData: function(t, e) {
			var n = this.getAxis("x").scale,
				...
				a = n.parse(t[0]),
				s = i.parse(t[1]);
			return e = e || [], e[0] = Math.min(Math.max(Math.min(r[0], r[1]), a), Math.max(r[0], r[1])), e[1] = Math.min(
				Math.max(Math.min(o[0], o[1]), s), Math.max(o[0], o[1])), e
		},
		pointToData: function(t, e) {
	...
	Ib.categoryAxis = i({
		...
		min: "dataMin",
		max: "dataMax"
	}, Ib.valueAxis), Ib.logAxis = a({
		scale: !0,
		logBase: 10
	}, Ib.valueAxis);
	var Tb = ["value", "category", "time", "log"],
		Cb = function(t, e, n, o) {
			d(Tb, function(a) {
				e.extend({
					type: t + "Axis." + a,
	...
	kb.type = "grid", kb.axisPointerEnabled = !0, kb.getRect = function() {
		...
		var n, i, r = e.seriesModel,
			...
			s = e.gridModel,
			u = this._coordsList;
		return r ? l(u, n = r.coordinateSystem) < 0 && (n = null) : o && a ? n = this.getCartesian(o.componentIndex, a.componentIndex) :
			o ? i = this.getAxis("x", o.componentIndex) : a ? i = this.getAxis("y", a.componentIndex) : s && s.coordinateSystem ===
		...
		function i(n) {
			return function(i, s) {
				if (Eu(i, t, e)) {
					...
					var u = new Sb(n, Ml(i), [0, 0], i.get("type"), l),
						h = "category" === u.type;
					u.onBand = h && i.get("boundaryGap"), u.inverse = i.get("inverse"), i.axis = u, u.model = i, u.grid = this, u.index =
						s, this._axesList.push(u), o[n][s] = u, a[n]++
				}
			}
		}
		var r = {
	...
	var zb = {
					...
					if ("number" == typeof h && (h = [h, h]), null != l) {
						...
						d([{
							...
							if ("none" !== l[n] && null != l[n]) {
								var i = Pl(l[n], -c / 2, -f / 2, c, f, s.stroke, !0),
									o = e.r + e.offset,
			...
			axisName: function() {
				...
				if (n) {
					var i, r = e.get("nameLocation"),
						...
						h = u[0] > u[1] ? -1 : 1,
						c = ["start" === r ? u[0] - h * l : "end" === r ? u[1] + h * l : (u[0] + u[1]) / 2, ju(r) ? t.labelOffset + a *
							l : 0
						],
						d = e.get("nameRotate");
					null != d && (d = d * Lb / 180);
					var f;
					ju(r) ? i = Eb(t.rotation, null != d ? d : t.rotation, a) : (i = Gu(t, r, d || 0, u), null != (f = t.axisNameAvailableWidth) &&
						(f = Math.abs(f / Math.sin(i.rotation)), !isFinite(f) && (f = null)));
					var p = s.getFont(),
						g = e.get("nameTruncate", !0) || {},
						m = g.ellipsis,
						v = T(t.nameTruncateMaxWidth, g.maxWidth, f),
						y = null != m && null != v ? Xy(n, v, p, m, {
							minChar: 2,
					...
					ar(b.style, s, {
						...
						}), e.get("triggerEvent") && (b.eventData = Hu(e), b.eventData.targetType = "axisName", b.eventData.name = n),
		...
		Eb = Ob.innerTextLayout = function(t, e, n) {
			var i, r, o = Nr(e - t);
			return Rr(o) ? (r = n > 0 ? "top" : "bottom", i = "center") : Rr(o - Lb) ? (r = n > 0 ? "bottom" : "top", i =
				"center") : (r = "middle", i = o > 0 && o < Lb ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
				rotation: o,
				textAlign: i,
				textVerticalAlign: r
			}
	...
	var Vb = ["axisLine", "axisTickLabel", "axisName"],
		Wb = ["splitArea", "splitLine"],
		Hb = Bb.extend({
			type: "cartesianAxis",
				...
				if (!n.scale.isBlank()) {
					...
					if (l.length) {
						...
						for (var m = 1; m < l.length; m++) {
							...
							n.isHorizontal() ? (v = p, x = s.y, _ = b - v, w = s.height, p = v + _) : (v = s.x, x = p, _ = s.width, p = x +
								(w = b - x));
		...
		return {
			...
			reset: function(t, e, n) {
				...
				if ("cartesian2d" === o.type && r) {
					...
					if (h > 1) {
						var c;
						"string" == typeof r ? c = _b[r] : "function" == typeof r && (c = r), c && t.setData(i.downSample(i.mapDimension(
							s.dim), 1 / h, c, wb))
					}
				}
			}
		...
		_renderNormal: function(t, e, n) {
			...
			o.diff(a).add(function(e) {
				...
				if (o.hasValue(e)) {
					...
					l ? gr(l, {
						shape: c
					}, u, e) : l = Xb[s.type](o, e, h, c, i, u, !0), o.setItemGraphicEl(e, l), r.add(l), gh(l, o, e, h, c, t, i,
						"polar" === s.type)
				} else r.remove(l)
			}).remove(function(t) {
	...
	var Xb = {
			...
			polar: function(t, e, n, i, r, o, s) {
				...
				if (o) {
					var h = u.shape,
						c = r ? "r" : "endAngle",
						d = {};
					h[c] = r ? 0 : i.startAngle, d[c] = i[c], ky[s ? "updateProps" : "initProps"](u, {
						shape: d
					}, o, e)
				}
				return u
		...
		jb = Ii.extend({
			...
			buildPath: function(t, e) {
				for (var n = e.points, i = this.__startPoint, r = this.__valueIdx, o = 0; o < n.length; o += 2) i[this.__valueIdx] =
					n[o + r], t.moveTo(i[0], i[1]), t.lineTo(n[o], n[o + 1])
			}
		});
	ws(v(function(t, e) {
		var n = fl(t, e),
		...
		d(n, function(t) {
			...
			for (var d = e.mapDimension(h.dim), f = e.mapDimension(o.dim), p = Ks(e, d), g = h.isHorizontal(), m = xl(0, h),
					v = 0, y = e.count(); v < y; v++) {
				var x = e.get(d, v),
					_ = e.get(f, v);
				if (!isNaN(x)) {
					...
					var S, M, I, T;
					if (g) S = b, M = (C = n.dataToPoint([x, _]))[1] + l, I = C[0] - m, T = u, Math.abs(I) < c && (I = (I < 0 ?
						-1 : 1) * c), p && (r[a][_][w] += I);
					else {
						var C = n.dataToPoint([_, x]);
						S = C[0] + l, M = b, I = u, T = C[1] - m, Math.abs(T) < c && (T = (T <= 0 ? -1 : 1) * c), p && (r[a][_][w] +=
							T)
					}
					e.setItemLayout(v, {
						x: S,
	...
	var qb = function(t, e, n) {
		...
		Kb = Cs({
			...
			getDataParams: function(t) {
				var e = this.getData(),
					n = Kb.superCall(this, "getDataParams", t),
					i = [];
	...
	Qb.updateData = function(t, e, n) {
		...
		var s = this.childAt(0),
			...
			h = t.getItemLayout(e),
			c = o({}, h);
		c.label = null, n ? (s.setShape(c), "scale" === l.getShallow("animationType") ? (s.shape.r = h.r0, mr(s, {
			shape: {
				r: h.r
			}
		}, l, e)) : (s.shape.endAngle = h.startAngle, gr(s, {
			shape: {
				endAngle: h.endAngle
			}
		}, l, e))) : gr(s, {
		...
		f && s.attr("cursor", f), _h(this, t.getItemLayout(e), l.isSelected(null, e), l.get("selectedOffset"), l.get(
				"animation")), s.off("mouseover").off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && l.isAnimationEnabled() &&
			s.on("mouseover", i).on("mouseout", r).on("emphasis", i).on("normal", r), this._updateLabel(t, e), ir(this)
		...
		}), i.ignore = i.normalIgnore = !l.get("show"), i.hoverIgnore = !u.get("show"), n.ignore = n.normalIgnore = !h.get(
	...
	var nS = Ei({
			...
			buildPath: function(t, e) {
				...
				if (!((t.getContext ? t.getContext() : t) && i[0] < 4))
					for (var a = 0; a < n.length;) {
						var s = n[a++],
							l = n[a++];
						isNaN(s) || isNaN(l) || (o.x = s - i[0] / 2, o.y = l - i[1] / 2, o.width = i[0], o.height = i[1], r.buildPath(
							t, o, !0))
					}
			},
			afterBrush: function(t) {
			...
			findDataIndex: function(t, e) {
				for (var n = this.shape, i = n.points, r = n.size, o = Math.max(r[0], 4), a = Math.max(r[1], 4), s = i.length /
						2 - 1; s >= 0; s--) {
					var l = 2 * s,
						u = i[l] - o / 2,
						h = i[l + 1] - a / 2;
	...
	iS.isPersistent = function() {
		...
		this.group.removeAll(), this._clearIncremental(), t.count() > 2e6 ? (this._incremental || (this._incremental = new zi({
			silent: !0
		...
		t.setShape("size", r instanceof Array ? r : [r, r]), t.symbolProxy = Pl(e.getVisual("symbol"), 0, 0, 0, 0), t.setColor =
		...
		_updateSymbolDraw: function(t, e) {
			...
			return n && i === this._isLargeDraw || (n && n.remove(), n = this._symbolDraw = i ? new Mh : new lu, this._isLargeDraw =
				i, this.group.removeAll()), this.group.add(n.group), n
		},
		remove: function(t, e) {
			...
			if (e) {
				...
				d(e, function(e) {
					...
					"text" === e.type && u && (e.hv && e.hv[1] && (u.textVerticalAlign = u.textBaseline = null), !u.hasOwnProperty(
						...
						u.stroke));
					var h = Ch(e);
					r && "merge" !== r ? "replace" === r ? (Th(a, n), Ih(o, l, h, n)) : "remove" === r && Th(a, n) : a ? a.attr(
						h) : Ih(o, l, h, n);
					var c = n.get(o);
	...
	($h.prototype = {
		...
		render: function(t, e, n, i) {
			...
			if (this._axisModel = t, this._axisPointerModel = e, this._api = n, i || this._lastValue !== r || this._lastStatus !==
				...
				} else a = this._group = new Jg, this.createPointerEl(a, l, t, e), this.createLabelEl(a, l, t, e), n.getZr().add(
					a);
		...
		_renderHandle: function(t) {
			if (!this._dragging && this.updateHandleTransform) {
				...
				var l = r.get("size");
				y(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), xa(this, "_doDispatchAxisPointer", r.get("throttle") ||
					0, "fixRate"), this._moveHandleToValue(t, a)
			}
		},
		_moveHandleToValue: function(t, e) {
			Kh(this._axisPointerModel, !e && this._moveAnimation, this._handle, tc(this.getHandleTransform(t, this._axisModel,
	...
	var gS = $h.extend({
			makeElOption: function(t, e, n, i, r) {
				var o = n.axis,
					a = o.grid,
					s = i.get("type"),
					l = hc(a, o).getOtherAxis(o).getGlobalExtent(),
			...
			updateHandleTransform: function(t, e, n, i) {
				var r = n.axis,
					...
					s = hc(o, r).getOtherAxis(r).getGlobalExtent(),
					l = "x" === r.dim ? 0 : 1,
					u = t.position;
	...
	gc.prototype = {
		...
		show: function(t) {
			...
			var e = this.el;
			e.style.cssText = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;" + pc(t) +
		...
		getOuterSize: function() {
			...
			if (document.defaultView && document.defaultView.getComputedStyle) {
				...
				n && (t += parseInt(n.paddingLeft, 10) + parseInt(n.paddingRight, 10) + parseInt(n.borderLeftWidth, 10) +
					parseInt(n.borderRightWidth, 10), e += parseInt(n.paddingTop, 10) + parseInt(n.paddingBottom, 10) + parseInt(n
						.borderTopWidth, 10) + parseInt(n.borderBottomWidth, 10))
			}
			return {
				width: t,
				height: e
	...
	Ts({
		...
		manuallyHideTip: function(t, e, n, i) {
			...
			!this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")), this._lastX =
				this._lastY = null, i.from !== this.uid && this._hide(yc(i, n))
		},
		_manuallyAxisShowTip: function(t, e, n, i) {
			...
			if (null != r && null != o && null != a) {
				...
				if (s && "axis" === (t = vc([s.getData().getItemModel(o), s, (s.coordinateSystem || {}).model, t])).get(
						"trigger")) return n.dispatchAction({
					type: "updateAxisPointer",
					seriesIndex: r,
					dataIndex: o,
					position: i.position
		...
		_tryShow: function(t, e) {
			...
			if (this._tooltipModel) {
				...
				i && i.length ? this._showAxisTooltip(i, t) : n && null != n.dataIndex ? (this._lastDataByCoordSys = null, this
		...
		_showAxisTooltip: function(t, e) {
					...
					if (e && null != r) {
						...
						d(t.seriesDataIndices, function(a) {
							...
							if (f.axisDim = t.axisDim, f.axisIndex = t.axisIndex, f.axisType = t.axisType, f.axisId = t.axisId, f.axisValue =
								Cl(e.axis, r), f.axisValueLabel = l, f) {
								s.push(f);
			...
			this._showOrMove(l, function() {
				this._updateContentNotChangedOnAxis(t) ? this._updatePosition(l, f, o[0], o[1], this._tooltipContent, s) :
					this._showTooltipContent(l, a, s, Math.random(), o[0], o[1], f, void 0, c)
			})
		},
		...
		_showComponentItemTooltip: function(t, e, n) {
			...
			var o = new Sr(i, this._tooltipModel, this._ecModel),
				a = o.get("content"),
				s = Math.random();
		...
		_showTooltipContent: function(t, e, n, i, r, o, a, s, l) {
			if (this._ticket = "", t.get("showContent") && t.get("show")) {
				...
				a = a || t.get("position");
				var c = e;
				if (h && "string" == typeof h) c = Ur(h, n, !0);
		...
		_updatePosition: function(t, e, n, i, r, o, a) {
			...
			} else "string" == typeof e && a ? (n = (p = wc(e, d, u))[0], i = p[1]) : (n = (p = xc(n, i, r, s, l, h ? null :
				20, c ? null : 20))[0], i = p[1]);
			if (h && (n -= bc(h) ? u[0] / 2 : "right" === h ? u[0] : 0), c && (i -= bc(c) ? u[1] / 2 : "bottom" === c ? u[1] :
					0), t.get("confine")) {
				var p = _c(n, i, r, s, l);
				n = p[0], i = p[1]
			}
	...
	_s("legendToggleSelect", "legendselectchanged", v(Sc, "toggleSelected")), _s("legendSelect", "legendselected", v(Sc,
		"select")), _s("legendUnSelect", "legendunselected", v(Sc, "unSelect"));
	var IS = v,
		TS = d,
		CS = Jg,
		AS = Ts({
					...
					if (this.newlineDisabled || "" !== h && "\n" !== h) {
						...
						if (!o.get(h))
							if (c) {
								...
								this._createItem(h, u, l, e, p, g, t, f, a).on("click", IS(Tc, h, i)).on("mouseover", IS(Cc, c.name, null,
									i, s)).on("mouseout", IS(Ac, c.name, null, i, s)), o.set(h, !0)
								...
								if (!o.get(h) && n.legendDataProvider) {
									...
									this._createItem(h, u, l, e, "roundRect", null, t, d, a).on("click", IS(Tc, h, i)).on("mouseover", IS(
										Cc, null, h, i, s)).on("mouseout", IS(Ac, null, h, i, s)), o.set(h, !0)
								}
							}, this)
					} else r.add(new CS({
						newline: !0
	...
	var DS = MS.extend({
		...
		OS = AS.extend({
			...
			newlineDisabled: !0,
			init: function() {
				OS.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new kS), this._containerGroup
					.add(this.getContentGroup()), this.group.add(this._controllerGroup = new kS), this._showController
			},
			resetInner: function() {
				OS.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this
			...
			layoutInner: function(t, e, n) {
				var i = this.getContentGroup(),
					...
					l = PS[1 - a],
					u = LS[1 - a];
				Qy(t.get("orient"), i, t.get("itemGap"), a ? n.width : null, a ? null : n.height), Qy("horizontal", o, t.get(
					"pageButtonItemGap", !0));
				...
				d && ("end" === t.get("pageButtonPosition", !0) ? g[a] += n[s] - c[s] : p[a] += c[s] + m), g[1 - a] += h[l] / 2 -
					c[l] / 2, i.attr("position", f), r.attr("position", p), o.attr("position", g);
				var v = this.group.getBoundingRect();
				if ((v = {
						x: 0,
						y: 0
					})[s] = d ? n[s] : h[s], v[l] = Math.max(h[l], c[l]), v[u] = Math.min(0, c[u] + g[1 - a]), r.__rectSize = n[s],
					d) {
					var y = {
						x: 0,
						y: 0
					};
					y[s] = Math.max(n[s] - c[s] - m, 0), y[l] = v[l], r.setClipPath(new py({
						shape: y
					})), r.__rectSize = y[s]
			...
			_updatePageInfoView: function(t, e) {
				...
				d(["pagePrev", "pageNext"], function(i) {
					var r = null != e[i + "DataIndex"],
						o = n.childOfName(i);
					o && (o.setStyle("fill", r ? t.get("pageIconColor", !0) : t.get("pageIconInactiveColor", !0)), o.cursor = r ?
						"pointer" : "default")
				});
			...
			_getPageInfo: function(t) {
				...
				if (o) {
					var m = o.getBoundingRect(),
						v = o.position[h] + m[f];
					p[h] = -v - l[f], n = Math.floor(g * (v + m[f] + u / 2) / l[c]), n = l[c] && g ? Math.max(0, Math.min(g - 1, n)) :
						-1;
					var y = {
						x: 0,
						y: 0
					...
					if (s.eachChild(function(t, n) {
							var i = e(t);
							i.intersect(y) && (null == x && (x = n), r = t.__legendDataIndex), n === _.length - 1 && i[f] + i[c] <= y[f] +
								y[c] && (r = null)
						}), null != x) {
						var w = e(_[x]);
	...
	_s("legendScroll", "legendscroll", function(t, e) {
		...
		render: function(t, e, n) {
			if (this.group.removeAll(), t.get("show")) {
				...
				a || ("middle" === (a = t.get("left") || t.get("right")) && (a = "center"), "right" === a ? v.x += v.width :
					"center" === a && (v.x += v.width / 2)), s || ("center" === (s = t.get("top") || t.get("bottom")) && (s =
					"middle"), "bottom" === s ? v.y += v.height : "middle" === s && (v.y += v.height / 2), s = s || "top"), i.attr(
					"position", [v.x, v.y]);
				var y = {
					textAlign: a,
					textVerticalAlign: s
		...
		NS = Is({
			...
			formatTooltip: function(t) {
				var e = this.getData(),
					...
					i = y(n) ? f(n, zS).join(", ") : zS(n),
					r = e.getName(t),
					o = ES(this.name);
				return (null != n || r) && (o += "<br />"), r && (o += ES(r), null != n && (o += " : ")), null != n && (o += ES(
					i)), o
			},
			getData: function() {
				return this._data
	...
	var WS = gy.prototype,
		...
		GS = Ei({
			...
			tangentAt: function(t) {
				var e = this.shape,
					n = Hc(e) ? [e.x2 - e.x1, e.y2 - e.y1] : HS.tangentAt.call(this, t);
				return Y(n, n)
			}
		}),
		ZS = ["fromSymbol", "toSymbol"],
		US = Yc.prototype;
	US.beforeUpdate = function() {
		...
		if (e || n || !i.ignore) {
			...
			if (this.__dirty || a.__dirty) {
				var s = a.shape.percent,
					...
					u = a.pointAt(s),
					h = G([], u, l);
				if (Y(h, h), e && (e.attr("position", l), c = a.tangentAt(0), e.attr("rotation", Math.PI / 2 - Math.atan2(c[1], c[
						0])), e.attr("scale", [r * s, r * s])), n) {
					n.attr("position", u);
					var c = a.tangentAt(1);
				...
				if (!i.ignore) {
					i.attr("position", u);
					var d, f, p, g = 5 * r;
					if ("end" === i.__position) d = [h[0] * g + u[0], h[1] * g + u[1]], f = h[0] > .8 ? "left" : h[0] < -.8 ?
		...
		var i = t.hostModel,
			r = Uc(t.getItemLayout(e));
		r.shape.percent = 0, mr(r, {
			shape: {
				percent: 1
			}
		}, i, e), this.add(r);
		...
		if (!n || t.hasItemOption) {
			...
			o = h.getModel("lineStyle").getLineStyle(), s = h.getModel("emphasis.lineStyle").getLineStyle(), l = h.getModel(
	...
	var YS = function(t, e, r, a) {
		...
		if (!y(a) && ("min" === l || "max" === l || "average" === l || "median" === l || null != a.xAxis || null != a.yAxis)) {
			var u, h;
			if (null != a.yAxis || null != a.xAxis) u = null != a.yAxis ? "y" : "x", e.getAxis(u), h = T(a.yAxis, a.xAxis);
			else {
				var c = Ec(a, s, e, t);
	...
	var $S = ["cartesian2d", "polar", "singleAxis"],
		KS = function(t, e) {
			var n = f(t = t.slice(), qr),
				i = f(e = (e || []).slice(), qr);
			return function(r, o) {
				d(t, function(t, a) {
					for (var s = {
	...
	tM.prototype = {
		...
		getOtherAxisModel: function() {
			var t, e, n = this._dimName,
				i = this.ecModel,
				r = this.getAxisModel();
			"x" === n || "y" === n ? (e = "gridIndex", t = "x" === n ? "y" : "x") : (e = "polarIndex", t = "angle" === n ?
				"radius" : "angle");
			var o;
		...
		calculateDataWindow: function(t) {
			...
			return QS(["startValue", "endValue"], function(e) {
				...
				var s = a[t],
					l = o[t];
				"percent" === i[t] ? (null == l && (l = r[t]), s = n.parse(Ar(l, r, e, !0))) : l = Ar(s, e, r, !0), a[t] = s,
					o[t] = l
			}), {
				valueWindow: JS(a),
				percentWindow: JS(o)
	...
	var eM = d,
		...
		iM = Is({
			...
			doInit: function(t) {
				var e = this.option;
				Xp.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), vd(this, t), eM([
					["start", "startValue"],
					["end", "endValue"]
				], function(t, n) {
		...
		oM = (iM.extend({
			...
			var a = n[1] - n[0];
			null != r && (r = xd(r, [0, a])), null != o && (o = Math.max(o, null != r ? r : 0)), "all" === i && (r = o = Math.abs(
				e[1] - e[0]), i = 0);
			var s = yd(e, i);
			e[i] += t;
			var l = r || 0,
		...
		cM = "horizontal",
		dM = 5,
		fM = ["line", "bar", "candlestick", "scatter"],
		pM = rM.extend({
			type: "dataZoom.slider",
			init: function(t, e) {
			...
			render: function(t, e, n, i) {
				pM.superApply(this, "render", arguments), xa(this, "_dispatchZoomAction", this.dataZoomModel.get("throttle"),
					"fixRate"), this._orient = t.get("orient"), !1 !== this.dataZoomModel.get("show") ? (i && "dataZoom" === i.type &&
					i.from === this.uid || this._buildView(), this._updateView()) : this.group.removeAll()
			},
			remove: function() {
			...
			_renderHandle: function() {
				...
				i.add(t.filler = new aM({
					...
					var r = br(o.get("handleIcon"), {
						...
						a = r.getBoundingRect();
					this._handleHeight = Dr(o.get("handleSize"), this._size[1]), this._handleWidth = a.width / a.height * this._handleHeight,
			...
			_updateInterval: function(t, e) {
				var n = this.dataZoomModel,
					...
					a = [0, 100];
				oM(e, i, r, n.get("zoomLock") ? "all" : t, null != o.minSpan ? sM(o.minSpan, a, r, !0) : null, null != o.maxSpan ?
					sM(o.maxSpan, a, r, !0) : null);
				var s = this._range,
					l = this._range = lM([sM(i[0], r, a, !0), sM(i[1], r, a, !0)]);
			...
			_updateDataInfo: function(t) {
				function e(t) {
					var e = vr(i.handles[t].parent, this.group),
						n = xr(0 === t ? "right" : "left", e),
						s = this._handleWidth / 2 + dM,
			...
			_formatLabel: function(t, e) {
				...
				var o = null == t || isNaN(t) ? "" : "category" === e.type || "time" === e.type ? e.scale.getLabel(Math.round(t)) :
	...
	var mM = "\0_ec_dataZoom_roams",
		...
		yM = rM.extend({
			...
			render: function(t, e, n, i) {
				yM.superApply(this, "render", arguments), this._range = t.getPercentRange(), d(this.getTargetCoordInfo(),
					function(e, i) {
			...
			zoom: function(t, e, n, i) {
				...
				if (a) {
					var s = _M[e](null, [i.originX, i.originY], a, n, t),
						l = (s.signal > 0 ? s.pixelStart + s.pixelLength - s.pixel : s.pixel - s.pixelStart) / s.pixelLength * (o[1] -
							o[0]) + o[0],
		...
		_M = {
			grid: function(t, e, n, i, r) {
				...
				return t = t || [0, 0], "x" === o.dim ? (a.pixel = e[0] - t[0], a.pixelLength = s.width, a.pixelStart = s.x, a.signal =
					o.inverse ? 1 : -1) : (a.pixel = e[1] - t[1], a.pixelLength = s.height, a.pixelStart = s.y, a.signal = o.inverse ?
					-1 : 1), a
			},
			polar: function(t, e, n, i, r) {
				...
				return t = t ? s.pointToCoord(t) : [0, 0], e = s.pointToCoord(e), "radiusAxis" === n.mainType ? (a.pixel = e[0] -
					t[0], a.pixelLength = l[1] - l[0], a.pixelStart = l[0], a.signal = o.inverse ? 1 : -1) : (a.pixel = e[1] - t[1],
					a.pixelLength = u[1] - u[0], a.pixelStart = u[0], a.signal = o.inverse ? -1 : 1), a
			},
			singleAxis: function(t, e, n, i, r) {
				var o = n.axis,
					a = r.model.coordinateSystem.getRect(),
					s = {};
				return t = t || [0, 0], "horizontal" === o.orient ? (s.pixel = e[0] - t[0], s.pixelLength = a.width, s.pixelStart =
					a.x, s.signal = o.inverse ? 1 : -1) : (s.pixel = e[1] - t[1], s.pixelLength = a.height, s.pixelStart = a.y, s.signal =
					o.inverse ? -1 : 1), s
			}
		};
	xs({
		...
		render: function(t, e, n, i) {
			...
			function o(i, r, o) {
				...
				d(h, function(o, h) {
					...
					d.setStyle(l.getItemStyle()), d.hoverStyle = u.getItemStyle(), ir(d), t.get("showTitle") && (d.__title = c[h],
						...
						})), d.trigger(i.get("iconStatus." + h) || "normal"), a.add(d), d.on("click", m(r.onclick, r, e, n, h)), g[
						h] = d
				})
			}
			var a = this.group;
			if (a.removeAll(), t.get("show")) {
				...
				d(l, function(t, e) {
						h.push(e)
					}), new ks(this._featureNames || [], h).add(r).update(r).remove(v(r, null)).execute(), this._featureNames = h,
					Mc(a, t, n), a.add(Ic(a.getBoundingRect(), t)), a.eachChild(function(t) {
						var e = t.__title,
							i = t.hoverStyle;
						if (i && e) {
							var r = Se(e, Be(i)),
							...
							o + r.width / 2 > n.getWidth() ? (i.textPosition = ["100%", u], i.textAlign = "right") : o - r.width / 2 <
								0 && (i.textPosition = [0, u], i.textAlign = "left")
						}
					})
			}
		},
	...
	Yd.defaultOption = {
		...
		if (r.href = a, "function" != typeof MouseEvent || Xp.browser.ie || Xp.browser.edge)
			if (window.navigator.msSaveOrOpenBlob) {
				...
				var c = n.get("lang"),
					d = '<body style="margin:0;"><img src="' + a + '" style="max-width:100%;" title="' + (c && c[0] || "") +
					'" /></body>';
	...
	var AM = t_.toolbox.dataView,
		DM = new Array(60).join("-"),
		kM = "\t",
		PM = new RegExp("[" + kM + "]+", "g"); of .defaultOption = {
		show: !0,
		readOnly: !1,
		...
		o.style.cssText = "position:absolute;left:5px;top:5px;bottom:5px;right:5px;", o.style.backgroundColor = r.get(
			"backgroundColor") || "#fff";
		...
		} else l.appendChild(u), u.readOnly = r.get("readOnly"), u.style.cssText =
			"width:100%;height:100%;font-family:monospace;font-size:14px;line-height:1.6rem;", u.style.color = r.get(
				"textColor"), u.style.borderColor = r.get("textareaBorderColor"), u.style.backgroundColor = r.get("textareaColor"),
			u.value = d.value;
		var p = d.meta,
		...
		}), v.innerHTML = s[1], y.innerHTML = s[2], y.style.cssText = m, v.style.cssText = m, !r.get("readOnly") && g.appendChild(
			y), g.appendChild(v), at(u, "keydown", function(t) {
		...
		}), o.appendChild(a), o.appendChild(l), o.appendChild(g), l.style.height = i.clientHeight - 80 + "px", i.appendChild(
			o), this._dom = o
	...
	var XM = {
			mousedown: function(t) {
				if (this._dragging) Vf.call(this, t);
		...
		$M = l,
		KM = v,
		QM = ["dataToPoint", "pointToData"],
		JM = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"],
		tI = Yf.prototype;
	tI.setOutputRanges = function(t, e) {
		this.matchOutputRanges(t, e, function(t, e, n) {
			if ((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange) {
				...
				t.__rangeOffset = {
					offset: oI[t.brushType](i.values, t.range, [1, 1]),
					xyMinMax: i.xyMinMax
				}
			}
		})
		...
		qM(t, function(t) {
			...
			if (t.range = t.range || [], n && !0 !== n) {
				t.panelId = n.panelId;
				var i = rI[t.brushType](0, n.coordSys, t.coordRange),
					r = t.__rangeOffset;
		...
		for (var n = this._targetInfoList, i = qf(e, t), r = 0; r < n.length; r++) {
			...
			if (a) {
				...
				for (r = 0; r < nI.length; r++)
					if (nI[r](i, o)) return o
		}
		return !0
	};
	var eI = {
		...
		rI = {
			...
			lineY: KM($f, 1),
			rect: function(t, e, n) {
				var i = e[QM[t]]([n[0][0], n[1][0]]),
					r = e[QM[t]]([n[0][1], n[1][1]]),
	...
	var lI = t_.toolbox.dataZoom,
		uI = d,
		hI = "\0_ec_\0toolbox-dataZoom_";
	op.defaultOption = {
		show: !0,
		icon: {
	...
	cI._onBrush = function(t, e) {
		function n(t, e, n) {
			...
			null == u.minValueSpan && null == u.maxValueSpan || (n = oM(0, n.slice(), a.scale.getExtent(), 0, u.minValueSpan,
				u.maxValueSpan)), l && (r[l.id] = {
				dataZoomId: l.id,
				startValue: n[0],
				endValue: n[1]
			})
		...
		if (e.isEnd && t.length) {
			var r = {},
				o = this.ecModel;
			this._brushController.updateCovers([]), new Yf(ap(this.model.option), o, {
				include: ["grid"]
	...
	var pI, gI = "urn:schemas-microsoft-com:vml",
		mI = "undefined" == typeof window ? null : window,
		vI = !1,
		yI = mI && mI.document;
	...
	if (!Xp.canvasSupported) {
		var TI = 21600,
			CI = TI / 2,
			AI = function(t) {
				t.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", t.coordsize = TI + "," + TI, t.coordorigin =
					"0,0"
			},
			DI = function(t) {
					...
					if (i instanceof _y) {
						...
						if (b >= 2) {
							var A = S[0][0],
								...
								k = S[0][1] * e.opacity,
								P = S[1][1] * e.opacity;
							t.type = r, t.method = "none", t.focus = "100%", t.angle = o, t.color = A, t.color2 = D, t.colors = M.join(","),
			...
			BI = function(t, e) {
				null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")), null == e.stroke || e.stroke instanceof _y || EI(t, e.stroke,
					e.opacity)
			},
			FI = function(t, e, n, i) {
				var r = "fill" == e,
					o = t.getElementsByTagName(e)[0];
				null != n[e] && "none" !== n[e] && (r || !r && n.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", n[e] instanceof _y &&
					LI(t, o), o || (o = hp(e)), r ? RI(o, n, i) : BI(o, n), PI(t, o)) : (t[r ? "filled" : "stroked"] = "false", LI(t,
					o))
			},
			VI = [
				[],
					...
					switch (r = p[o++], i = "", n = 0, r) {
						...
						case u:
							...
							var m, v, y = p[o++],
								...
								_ = p[o++],
								w = p[o++];
							r === d ? (m = _, v = w, _ = (_ + 2 * y) / 3, w = (w + 2 * x) / 3, y = (a + 2 * y) / 3, x = (s + 2 * x) / 3) :
								(m = p[o++], v = p[o++]), VI[0][0] = y, VI[0][1] = x, VI[1][0] = _, VI[1][1] = w, VI[2][0] = m, VI[2][1] = v,
								a = m, s = v;
							break;
						case c:
							var b = 0,
								...
								I = 1,
								T = 0;
							e && (b = e[4], S = e[5], M = wI(e[0] * e[0] + e[1] * e[1]), I = wI(e[2] * e[2] + e[3] * e[3]), T = Math.atan2(
								-e[1] / I, e[0] / M));
							var C = p[o++],
								A = p[o++],
								D = p[o++],
							...
							var O = p[o++],
								...
								x = A + MI(L) * k,
								N = O ? " wa " : " at ";
							Math.abs(z - y) < 1e-4 && (Math.abs(L - P) > .01 ? O && (z += .0125) : Math.abs(E - A) < 1e-4 ? O && z < C || !
								O && z > C ? x -= .0125 : x += .0125 : O && E < A || !O && E > A ? y += .0125 : y -= .0125), f.push(N, _I(((C -
								D) * M + b) * TI - CI), ",", _I(((A - k) * I + S) * TI - CI), ",", _I(((C + D) * M + b) * TI - CI), ",", _I(
								((A + k) * I + S) * TI - CI), ",", _I((z * M + b) * TI - CI), ",", _I((E * I + S) * TI - CI), ",", _I((y * M +
								b) * TI - CI), ",", _I((x * I + S) * TI - CI)), a = y, s = x;
							break;
						case xI.R:
							var R = VI[0],
								B = VI[1];
							R[0] = p[o++], R[1] = p[o++], B[0] = R[0] + p[o++], B[1] = R[1] + p[o++], e && ($(R, R, e), $(B, B, e)), R[0] =
								_I(R[0] * TI - CI), B[0] = _I(B[0] * TI - CI), R[1] = _I(R[1] * TI - CI), B[1] = _I(B[1] * TI - CI), f.push(
									" m ", R[0], ",", R[1], " l ", B[0], ",", R[1], " l ", B[0], ",", B[1], " l ", R[0], ",", B[1]);
							break;
						case xI.Z:
							f.push(" x ")
					}
		...
		Ii.prototype.brushVML = function(t) {
			...
			this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1), n.path =
				WI(l, this.transform), n.style.zIndex = OI(this.zlevel, this.z, this.z2), PI(t, n), null != e.text ? this.drawRectText(
		...
		an.prototype.brushVML = function(t) {
			...
			if (HI(r)) {
				...
				if (o === this._imageSrc) e = this._imageWidth, n = this._imageHeight;
					...
					var a = r.runtimeStyle,
						s = a.width,
						l = a.height;
					a.width = "auto", a.height = "auto", e = r.width, n = r.height, a.width = s, a.height = l, this._imageSrc = o,
						this._imageWidth = e, this._imageHeight = n
				}
				r = o
			...
			if (r) {
				...
				var x, _ = y.style,
					...
					b = 1,
					S = 1;
				if (this.transform && (x = this.transform, b = wI(x[0] * x[0] + x[1] * x[1]), S = wI(x[2] * x[2] + x[3] * x[3]),
						w = x[1] || x[2]), w) {
					var M = [u, h],
						I = [u + c, h],
						T = [u, h + d],
					...
					var A = II(M[0], I[0], T[0], C[0]),
						D = II(M[1], I[1], T[1], C[1]),
						k = [];
					k.push("M11=", x[0] / b, ",", "M12=", x[2] / S, ",", "M21=", x[1] / b, ",", "M22=", x[3] / S, ",", "Dx=", _I(u *
							b + x[4]), ",", "Dy=", _I(h * S + x[5])), _.padding = "0 " + _I(A) + "px " + _I(D) + "px 0", _.filter =
						"progid:DXImageTransform.Microsoft.Matrix(" + k.join("") + ", SizingMethod=clip)"
				...
				var O = P.style;
				if (v) {
					if (e && n) O.width = _I(b * e * c / f) + "px", O.height = _I(S * n * d / p) + "px";
					else {
						var z = new Image,
							E = this;
						z.onload = function() {
							z.onload = null, e = z.width, n = z.height, O.width = _I(b * e * c / f) + "px", O.height = _I(S * n * d / p) +
								"px", E._imageWidth = e, E._imageHeight = n, E._imageSrc = r
						}, z.src = r
					}
					L || ((L = yI.createElement("div")).style.overflow = "hidden", this._cropEl = L);
					var N = L.style;
					N.width = _I((c + g * c / f) * b), N.height = _I((d + m * d / p) * S), N.filter =
						"progid:DXImageTransform.Microsoft.Matrix(Dx=" + -g * c / f * b + ",Dy=" + -m * d / p * S + ")", L.parentNode ||
						y.appendChild(L), P.parentNode != L && L.appendChild(P)
				} else O.width = _I(b * c) + "px", O.height = _I(S * d) + "px", y.appendChild(P), L && L.parentNode && (y.removeChild(
					L), this._cropEl = null);
				var R = "",
					B = i.opacity;
				B < 1 && (R += ".Alpha(opacity=" + _I(100 * B) + ") "), R +=
					"progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" + r + ", SizingMethod=scale)", O.filter = R, y.style.zIndex =
					OI(this.zlevel, this.z, this.z2), PI(t, y), null != i.text && this.drawRectText(t, this.getBoundingRect())
			}
		...
		! function(t, e) {
			...
			var n = yI;
			GI || ((GI = n.createElement("div")).style.cssText =
				"position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;", yI.body.appendChild(GI)
			);
			try {
				GI.style.font = e
			} catch (t) {}
			return GI.innerHTML = "", GI.appendChild(n.createTextNode(t)), {
				width: GI.offsetWidth
			}
		});
		for (var jI = new re, qI = [Mm, on, an, Ii, ry], $I = 0; $I < qI.length; $I++) {
			...
			KI.drawRectText = function(t, e, n, i) {
				...
				if (null != o && (o += ""), o) {
					...
					if (v && !i && (jI.copy(e), jI.applyTransform(v), e = jI), i) c = e.x, d = e.y;
					else {
						var y = r.textPosition,
							x = r.textDistance;
						if (y instanceof Array) c = e.x + zI(y[0], e.width), d = e.y + zI(y[1], e.height), f = f || "left";
						else {
							var _ = Ae(y, e, x);
					...
					I ? b = (w = (S = I.firstChild).nextSibling).nextSibling : (I = M("line"), w = M("path"), b = M("textpath"), S =
						M("skew"), b.style["v-text-align"] = "left", AI(I), w.textpathok = !0, b.on = !0, I.from = "0 0", I.to =
						"1000 0.05", PI(I, S), PI(I, w), PI(I, b), this._textVmlEl = I);
					var T = [c, d],
						C = I.style;
					v && i ? ($(T, T, v), S.on = !0, S.matrix = v[0].toFixed(3) + "," + v[2].toFixed(3) + "," + v[1].toFixed(3) +
						"," + v[3].toFixed(3) + ",0,0", S.offset = (_I(T[0]) || 0) + "," + (_I(T[1]) || 0), S.origin = "0 0", C.left =
						"0px", C.top = "0px") : (S.on = !1, C.left = _I(c) + "px", C.top = _I(d) + "px"), b.string = DI(o);
					try {
						b.style.font = m
					} catch (t) {}
					FI(I, "fill", {
		...
		_paintList: function(t) {
			for (var e = this._vmlRoot, n = 0; n < t.length; n++) {
				...
				i.invisible || i.ignore ? (i.__alreadyNotVisible || i.onRemove(e), i.__alreadyNotVisible = !0) : (i.__alreadyNotVisible &&
					i.onAdd(e), i.__alreadyNotVisible = !1, i.__dirty && (i.beforeBrush && i.beforeBrush(), (i.brushVML || i.brush)
						.call(i, e), i.afterBrush && i.afterBrush())), i.__dirty = !1
			}
	...
	hT.brush = function(t) {
		...
		if (n instanceof HTMLImageElement && (n = n.src), n) {
			var i = e.x || 0,
				...
				a = e.height,
				s = t.__svgEl;
			s || (s = gp("image"), t.__svgEl = s), n !== t.__imageSrc && (bp(s, "href", n), t.__imageSrc = n), wp(s, "width",
				o), wp(s, "height", a), wp(s, "x", i), wp(s, "y", r), _p(s, t.transform), null != e.text && fT(t, t.getBoundingRect())
		}
	};
	var cT = {},
		dT = new re,
		fT = function(t, e, n) {
			...
			if (null != r) {
				...
				var c = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || ym,
					d = Ip(i.textVerticalAlign),
					f = (n = Se(r, c, h, d)).lineHeight;
				...
				var g = i.textPadding;
				if (wp(o, "x", a), wp(o, "y", s), Sp(o, i, !0, t), t instanceof ry || t.style.transformText) _p(o, t.transform);
				else {
					if (t.transform) dT.copy(e), dT.applyTransform(t.transform), e = dT;
					else {
				...
				var _ = r.split("\n"),
					w = _.length,
					b = h;
				"left" === b ? (b = "start", g && (a += g[3])) : "right" === b ? (b = "end", g && (a -= g[1])) : "center" === b &&
					(b = "middle", g && (a += (g[3] - g[1]) / 2));
				var S = 0;
				if ("after-edge" === d ? (S = -n.height + f, g && (S -= g[2])) : "middle" === d ? (S = (-n.height + f) / 2, g && (
						s += (g[0] - g[2]) / 2)) : g && (S += g[0]), t.__text !== r || t.__textFont !== c) {
					var M = t.__tspanList || [];
					t.__tspanList = M;
					for (T = 0; T < w; T++)(C = M[T]) ? C.innerHTML = "" : (C = M[T] = gp("tspan"), o.appendChild(C), wp(C,
						"alignment-baseline", d), wp(C, "text-anchor", b)), wp(C, "x", a), wp(C, "y", s + T * f + S), C.appendChild(
	...
	cT.drawRectText = fT, cT.brush = function(t) {
				...
				var d = function() {
					for (var n = -1 * a; n <= a; n += 2) {
						...
						var d = u && u.newPos + 1 < r,
							f = h && 0 <= c && c < o;
						if (d || f) {
							if (!d || f && u.newPos < h.newPos ? (s = Ap(h), i.pushComponent(s.components, void 0, !0)) : ((s = u).newPos++,
									i.pushComponent(s.components, !0, void 0)), c = i.extractCommon(s, e, t, n), s.newPos + 1 >= r && c + 1 >=
								o) return Cp(0, s.components);
							l[n] = s
						} else l[n] = void 0
					}
					a++
		...
		extractCommon: function(t, e, n, i) {
			for (var r = e.length, o = n.length, a = t.newPos, s = a - i, l = 0; a + 1 < r && s + 1 < o && this.equals(e[a +
					1], n[s + 1]);) a++, s++, l++;
	...
	Dp.prototype.createElement = gp, Dp.prototype.getDefs = function(t) {
		...
		Dp.prototype.update.call(this, t, function() {
			var n = t.type,
				i = t._dom.tagName;
			"linear" === n && "linearGradient" === i || "radial" === n && "radialGradient" === i ? e.updateDom(t, t._dom) :
		...
		if (t.style) {
			var e = t.style.fill;
			e && e._dom && Dp.prototype.markUsed.call(this, e._dom), (e = t.style.stroke) && e._dom && Dp.prototype.markUsed.call(
				this, e._dom)
		}
		...
		if (e && e.length > 0) {
			var i, r, o = this.getDefs(!0),
				a = e[0],
				s = n ? "_textDom" : "_dom";
			a[s] ? (r = a[s].getAttribute("id"), i = a[s], o.contains(i) || o.appendChild(i)) : (r = "zr" + this._zrId +
				"-clip-" + this.nextId, ++this.nextId, (i = this.createElement("clipPath")).setAttribute("id", r), o.appendChild(
					i), a[s] = i);
			...
			i.innerHTML = "", i.appendChild(h.cloneNode()), t.setAttribute("clip-path", "url(#" + r + ")"), e.length > 1 &&
				this.updateDom(i, e.slice(1), n)
		...
		if (s.shadowBlur || s.shadowOffsetX || s.shadowOffsetY) i = s.shadowOffsetX || 0, r = s.shadowOffsetY || 0, o = s.shadowBlur,
			a = s.shadowColor;
		else {
		...
		var h = o / 2 / l + " " + o / 2 / u;
		n.setAttribute("stdDeviation", h), e.setAttribute("x", "-100%"), e.setAttribute("y", "-100%"), e.setAttribute(
				"width", Math.ceil(o / 2 * 200) + "%"), e.setAttribute("height", Math.ceil(o / 2 * 200) + "%"), e.appendChild(n),
			s._shadowDom = e
	...
	var mT = function(t, e, n, i) {
		...
		r.setAttribute("xmlns", "http://www.w3.org/2000/svg"), r.setAttribute("version", "1.1"), r.setAttribute(
			...
			new kp(i, r), this.clipPathManager = new Pp(i, r), this.shadowManager = new Lp(i, r);
		var a = document.createElement("div");
		a.style.cssText = "overflow:hidden;position:relative", this._svgRoot = r, this._viewport = a, t.appendChild(a), a.appendChild(
			r), this.resize(n.width, n.height), this._visibleList = []
	};
	mT.prototype = {
			constructor: mT,
			getType: function() {
			...
			_paintList: function(t) {
				...
				for (e = 0; e < r; e++) {
					var a = Ep(f = t[e]),
						s = Wp(f) || Vp(f);
					f.invisible || (f.__dirty && (a && a.brush(f), this.clipPathManager.update(f), f.style && (this.gradientManager.update(
				...
				for (e = 0; e < u.length; e++) {
					...
					if (c.added)
						for (d = 0; d < c.count; d++) {
							var s = Wp(f = o[c.indices[d]]),
								h = Vp(f);
							l ? Rp(n, s, l) : Bp(n, s), s ? Rp(n, h, s) : l ? Rp(n, h, l) : Bp(n, h), Rp(n, h, s), l = h || s || l, this.gradientManager
								.addWithoutUpdate(s, f), this.shadowManager.addWithoutUpdate(l, f), this.clipPathManager.markUsed(f)
						} else if (!c.removed)
							for (var d = 0; d < c.count; d++) {
								var f = o[c.indices[d]];
								l = s = Vp(f) || Wp(f) || l, this.gradientManager.markUsed(f), this.gradientManager.addWithoutUpdate(s, f),
			...
			resize: function(t, e) {
				...
				n.style.display = "none";
				var i = this._opts;
				if (null != t && (i.width = t), null != e && (i.height = e), t = this._getSize(0), e = this._getSize(1), n.style.display =
					"", this._width !== t || this._height !== e) {
					this._width = t, this._height = e;
					var r = n.style;
		...
		}, t.registerLayout = ws, t.registerVisual = bs, t.registerLoading = Ms, t.extendComponentModel = Is, t.extendComponentView =
		Ts, t.extendSeriesModel = Cs, t.extendChartView = As, t.setCanvasCreator = function(t) {
			e("createCanvas", t)
		...
		}, t.dataTool = tw, t.zrender = Wm, t.number = Vy, t.format = jy, t.throttle = ya, t.helper = Xw, t.matrix = bg, t.vector =
		dg, t.color = Wg, t.parseGeoJSON = jw, t.parseGeoJson = Qw, t.util = Jw, t.graphic = tb, t.List = uw, t.Model = Sr,
		t.Axis = Kw, t.env = Xp
});
