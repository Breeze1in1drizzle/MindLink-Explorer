...
@author: Yongrui Huang
  ...
  This is an example for processing fusion algorithm in MAHNOB_HCI dataset using the function in ../algorithm_implement/adaboost_tool script
...
if __name__ == '__main__':
    ...
    for subject_id in range(1, 10):
        ...
        for validation_trial_id in range(1, 21):
            ...
            adaboost_model = adaboost_tool.AdaboostModel(preprocessed = False)
